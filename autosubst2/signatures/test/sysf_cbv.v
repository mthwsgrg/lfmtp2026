...
Fixpoint ren_tm { mty mvl : nat } { nty nvl : nat } (xity : (fin) (mty) -> (fin) (nty)) (xivl : (fin) (mvl) -> (fin) (nvl)) (s : tm (mty) (mvl)) : tm (nty) (nvl) :=
    match s return tm (nty) (nvl) with
 ...
 with ren_vl { mty mvl : nat } { nty nvl : nat } (xity : (fin) (mty) -> (fin) (nty)) (xivl : (fin) (mvl) -> (fin) (nvl)) (s : vl (mty) (mvl)) : vl (nty) (nvl) :=
    match s return vl (nty) (nvl) with
...
Fixpoint idSubst_tm { mty mvl : nat } (sigmaty : (fin) (mty) -> ty (mty)) (sigmavl : (fin) (mvl) -> vl (mty) (mvl)) (Eqty : forall x, sigmaty x = (var_ty (mty)) x) (Eqvl : forall x, sigmavl x = (var_vl (mty) (mvl)) x) (s : tm (mty) (mvl)) : subst_tm sigmaty sigmavl s = s :=
    match s return subst_tm sigmaty sigmavl s = s with
 ...
 with idSubst_vl { mty mvl : nat } (sigmaty : (fin) (mty) -> ty (mty)) (sigmavl : (fin) (mvl) -> vl (mty) (mvl)) (Eqty : forall x, sigmaty x = (var_ty (mty)) x) (Eqvl : forall x, sigmavl x = (var_vl (mty) (mvl)) x) (s : vl (mty) (mvl)) : subst_vl sigmaty sigmavl s = s :=
    match s return subst_vl sigmaty sigmavl s = s with
    | var_vl (_) (_) s => Eqvl s
...
Fixpoint extRen_tm { mty mvl : nat } { nty nvl : nat } (xity : (fin) (mty) -> (fin) (nty)) (xivl : (fin) (mvl) -> (fin) (nvl)) (zetaty : (fin) (mty) -> (fin) (nty)) (zetavl : (fin) (mvl) -> (fin) (nvl)) (Eqty : forall x, xity x = zetaty x) (Eqvl : forall x, xivl x = zetavl x) (s : tm (mty) (mvl)) : ren_tm xity xivl s = ren_tm zetaty zetavl s :=
    match s return ren_tm xity xivl s = ren_tm zetaty zetavl s with
 ...
 with extRen_vl { mty mvl : nat } { nty nvl : nat } (xity : (fin) (mty) -> (fin) (nty)) (xivl : (fin) (mvl) -> (fin) (nvl)) (zetaty : (fin) (mty) -> (fin) (nty)) (zetavl : (fin) (mvl) -> (fin) (nvl)) (Eqty : forall x, xity x = zetaty x) (Eqvl : forall x, xivl x = zetavl x) (s : vl (mty) (mvl)) : ren_vl xity xivl s = ren_vl zetaty zetavl s :=
    match s return ren_vl xity xivl s = ren_vl zetaty zetavl s with
...
Fixpoint ext_tm { mty mvl : nat } { nty nvl : nat } (sigmaty : (fin) (mty) -> ty (nty)) (sigmavl : (fin) (mvl) -> vl (nty) (nvl)) (tauty : (fin) (mty) -> ty (nty)) (tauvl : (fin) (mvl) -> vl (nty) (nvl)) (Eqty : forall x, sigmaty x = tauty x) (Eqvl : forall x, sigmavl x = tauvl x) (s : tm (mty) (mvl)) : subst_tm sigmaty sigmavl s = subst_tm tauty tauvl s :=
    match s return subst_tm sigmaty sigmavl s = subst_tm tauty tauvl s with
 ...
 with ext_vl { mty mvl : nat } { nty nvl : nat } (sigmaty : (fin) (mty) -> ty (nty)) (sigmavl : (fin) (mvl) -> vl (nty) (nvl)) (tauty : (fin) (mty) -> ty (nty)) (tauvl : (fin) (mvl) -> vl (nty) (nvl)) (Eqty : forall x, sigmaty x = tauty x) (Eqvl : forall x, sigmavl x = tauvl x) (s : vl (mty) (mvl)) : subst_vl sigmaty sigmavl s = subst_vl tauty tauvl s :=
    match s return subst_vl sigmaty sigmavl s = subst_vl tauty tauvl s with
    | var_vl (_) (_) s => Eqvl s
...
Fixpoint compRenRen_tm { kty kvl : nat } { lty lvl : nat } { mty mvl : nat } (xity : (fin) (mty) -> (fin) (kty)) (xivl : (fin) (mvl) -> (fin) (kvl)) (zetaty : (fin) (kty) -> (fin) (lty)) (zetavl : (fin) (kvl) -> (fin) (lvl)) (rhoty : (fin) (mty) -> (fin) (lty)) (rhovl : (fin) (mvl) -> (fin) (lvl)) (Eqty : forall x, ((funcomp) zetaty xity) x = rhoty x) (Eqvl : forall x, ((funcomp) zetavl xivl) x = rhovl x) (s : tm (mty) (mvl)) : ren_tm zetaty zetavl (ren_tm xity xivl s) = ren_tm rhoty rhovl s :=
    match s return ren_tm zetaty zetavl (ren_tm xity xivl s) = ren_tm rhoty rhovl s with
 ...
 with compRenRen_vl { kty kvl : nat } { lty lvl : nat } { mty mvl : nat } (xity : (fin) (mty) -> (fin) (kty)) (xivl : (fin) (mvl) -> (fin) (kvl)) (zetaty : (fin) (kty) -> (fin) (lty)) (zetavl : (fin) (kvl) -> (fin) (lvl)) (rhoty : (fin) (mty) -> (fin) (lty)) (rhovl : (fin) (mvl) -> (fin) (lvl)) (Eqty : forall x, ((funcomp) zetaty xity) x = rhoty x) (Eqvl : forall x, ((funcomp) zetavl xivl) x = rhovl x) (s : vl (mty) (mvl)) : ren_vl zetaty zetavl (ren_vl xity xivl s) = ren_vl rhoty rhovl s :=
    match s return ren_vl zetaty zetavl (ren_vl xity xivl s) = ren_vl rhoty rhovl s with
...
Fixpoint compRenSubst_tm { kty kvl : nat } { lty lvl : nat } { mty mvl : nat } (xity : (fin) (mty) -> (fin) (kty)) (xivl : (fin) (mvl) -> (fin) (kvl)) (tauty : (fin) (kty) -> ty (lty)) (tauvl : (fin) (kvl) -> vl (lty) (lvl)) (thetaty : (fin) (mty) -> ty (lty)) (thetavl : (fin) (mvl) -> vl (lty) (lvl)) (Eqty : forall x, ((funcomp) tauty xity) x = thetaty x) (Eqvl : forall x, ((funcomp) tauvl xivl) x = thetavl x) (s : tm (mty) (mvl)) : subst_tm tauty tauvl (ren_tm xity xivl s) = subst_tm thetaty thetavl s :=
    match s return subst_tm tauty tauvl (ren_tm xity xivl s) = subst_tm thetaty thetavl s with
 ...
 with compRenSubst_vl { kty kvl : nat } { lty lvl : nat } { mty mvl : nat } (xity : (fin) (mty) -> (fin) (kty)) (xivl : (fin) (mvl) -> (fin) (kvl)) (tauty : (fin) (kty) -> ty (lty)) (tauvl : (fin) (kvl) -> vl (lty) (lvl)) (thetaty : (fin) (mty) -> ty (lty)) (thetavl : (fin) (mvl) -> vl (lty) (lvl)) (Eqty : forall x, ((funcomp) tauty xity) x = thetaty x) (Eqvl : forall x, ((funcomp) tauvl xivl) x = thetavl x) (s : vl (mty) (mvl)) : subst_vl tauty tauvl (ren_vl xity xivl s) = subst_vl thetaty thetavl s :=
    match s return subst_vl tauty tauvl (ren_vl xity xivl s) = subst_vl thetaty thetavl s with
    | var_vl (_) (_) s => Eqvl s
...
Fixpoint compSubstRen_tm { kty kvl : nat } { lty lvl : nat } { mty mvl : nat } (sigmaty : (fin) (mty) -> ty (kty)) (sigmavl : (fin) (mvl) -> vl (kty) (kvl)) (zetaty : (fin) (kty) -> (fin) (lty)) (zetavl : (fin) (kvl) -> (fin) (lvl)) (thetaty : (fin) (mty) -> ty (lty)) (thetavl : (fin) (mvl) -> vl (lty) (lvl)) (Eqty : forall x, ((funcomp) (ren_ty zetaty) sigmaty) x = thetaty x) (Eqvl : forall x, ((funcomp) (ren_vl zetaty zetavl) sigmavl) x = thetavl x) (s : tm (mty) (mvl)) : ren_tm zetaty zetavl (subst_tm sigmaty sigmavl s) = subst_tm thetaty thetavl s :=
    match s return ren_tm zetaty zetavl (subst_tm sigmaty sigmavl s) = subst_tm thetaty thetavl s with
 ...
 with compSubstRen_vl { kty kvl : nat } { lty lvl : nat } { mty mvl : nat } (sigmaty : (fin) (mty) -> ty (kty)) (sigmavl : (fin) (mvl) -> vl (kty) (kvl)) (zetaty : (fin) (kty) -> (fin) (lty)) (zetavl : (fin) (kvl) -> (fin) (lvl)) (thetaty : (fin) (mty) -> ty (lty)) (thetavl : (fin) (mvl) -> vl (lty) (lvl)) (Eqty : forall x, ((funcomp) (ren_ty zetaty) sigmaty) x = thetaty x) (Eqvl : forall x, ((funcomp) (ren_vl zetaty zetavl) sigmavl) x = thetavl x) (s : vl (mty) (mvl)) : ren_vl zetaty zetavl (subst_vl sigmaty sigmavl s) = subst_vl thetaty thetavl s :=
    match s return ren_vl zetaty zetavl (subst_vl sigmaty sigmavl s) = subst_vl thetaty thetavl s with
    | var_vl (_) (_) s => Eqvl s
...
Fixpoint compSubstSubst_tm { kty kvl : nat } { lty lvl : nat } { mty mvl : nat } (sigmaty : (fin) (mty) -> ty (kty)) (sigmavl : (fin) (mvl) -> vl (kty) (kvl)) (tauty : (fin) (kty) -> ty (lty)) (tauvl : (fin) (kvl) -> vl (lty) (lvl)) (thetaty : (fin) (mty) -> ty (lty)) (thetavl : (fin) (mvl) -> vl (lty) (lvl)) (Eqty : forall x, ((funcomp) (subst_ty tauty) sigmaty) x = thetaty x) (Eqvl : forall x, ((funcomp) (subst_vl tauty tauvl) sigmavl) x = thetavl x) (s : tm (mty) (mvl)) : subst_tm tauty tauvl (subst_tm sigmaty sigmavl s) = subst_tm thetaty thetavl s :=
    match s return subst_tm tauty tauvl (subst_tm sigmaty sigmavl s) = subst_tm thetaty thetavl s with
 ...
 with compSubstSubst_vl { kty kvl : nat } { lty lvl : nat } { mty mvl : nat } (sigmaty : (fin) (mty) -> ty (kty)) (sigmavl : (fin) (mvl) -> vl (kty) (kvl)) (tauty : (fin) (kty) -> ty (lty)) (tauvl : (fin) (kvl) -> vl (lty) (lvl)) (thetaty : (fin) (mty) -> ty (lty)) (thetavl : (fin) (mvl) -> vl (lty) (lvl)) (Eqty : forall x, ((funcomp) (subst_ty tauty) sigmaty) x = thetaty x) (Eqvl : forall x, ((funcomp) (subst_vl tauty tauvl) sigmavl) x = thetavl x) (s : vl (mty) (mvl)) : subst_vl tauty tauvl (subst_vl sigmaty sigmavl s) = subst_vl thetaty thetavl s :=
    match s return subst_vl tauty tauvl (subst_vl sigmaty sigmavl s) = subst_vl thetaty thetavl s with
    | var_vl (_) (_) s => Eqvl s
...
Fixpoint rinst_inst_tm { mty mvl : nat } { nty nvl : nat } (xity : (fin) (mty) -> (fin) (nty)) (xivl : (fin) (mvl) -> (fin) (nvl)) (sigmaty : (fin) (mty) -> ty (nty)) (sigmavl : (fin) (mvl) -> vl (nty) (nvl)) (Eqty : forall x, ((funcomp) (var_ty (nty)) xity) x = sigmaty x) (Eqvl : forall x, ((funcomp) (var_vl (nty) (nvl)) xivl) x = sigmavl x) (s : tm (mty) (mvl)) : ren_tm xity xivl s = subst_tm sigmaty sigmavl s :=
    match s return ren_tm xity xivl s = subst_tm sigmaty sigmavl s with
 ...
 with rinst_inst_vl { mty mvl : nat } { nty nvl : nat } (xity : (fin) (mty) -> (fin) (nty)) (xivl : (fin) (mvl) -> (fin) (nvl)) (sigmaty : (fin) (mty) -> ty (nty)) (sigmavl : (fin) (mvl) -> vl (nty) (nvl)) (Eqty : forall x, ((funcomp) (var_ty (nty)) xity) x = sigmaty x) (Eqvl : forall x, ((funcomp) (var_vl (nty) (nvl)) xivl) x = sigmavl x) (s : vl (mty) (mvl)) : ren_vl xity xivl s = subst_vl sigmaty sigmavl s :=
    match s return ren_vl xity xivl s = subst_vl sigmaty sigmavl s with
    | var_vl (_) (_) s => Eqvl s
...
Tactic Notation "asimpl" "in" "*" := auto_unfold in *; repeat first [progress rewrite ?instId_ty in *| progress rewrite ?compComp_ty in *| progress rewrite ?compComp'_ty in *| progress rewrite ?instId_tm in *| progress rewrite ?compComp_tm in *| progress rewrite ?compComp'_tm in *| progress rewrite ?instId_vl in *| progress rewrite ?compComp_vl in *| progress rewrite ?compComp'_vl in *| progress rewrite ?rinstId_ty in *| progress rewrite ?compRen_ty in *| progress rewrite ?compRen'_ty in *| progress rewrite ?renComp_ty in *| progress rewrite ?renComp'_ty in *| progress rewrite ?renRen_ty in *| progress rewrite ?renRen'_ty in *| progress rewrite ?rinstId_tm in *| progress rewrite ?compRen_tm in *| progress rewrite ?compRen'_tm in *| progress rewrite ?renComp_tm in *| progress rewrite ?renComp'_tm in *| progress rewrite ?renRen_tm in *| progress rewrite ?renRen'_tm in *| progress rewrite ?rinstId_vl in *| progress rewrite ?compRen_vl in *| progress rewrite ?compRen'_vl in *| progress rewrite ?renComp_vl in *| progress rewrite ?renComp'_vl in *| progress rewrite ?renRen_vl in *| progress rewrite ?renRen'_vl in *| progress rewrite ?varL_ty in *| progress rewrite ?varL_vl in *| progress rewrite ?varLRen_ty in *| progress rewrite ?varLRen_vl in *| progress (unfold up_ren, upRen_ty_ty, upRen_vl_ty, upRen_vl_vl, upRen_ty_vl, up_ty_ty, up_vl_ty, up_vl_vl, up_ty_vl in *)| progress (cbn [subst_ty subst_tm subst_vl ren_ty ren_tm ren_vl] in *)| fsimpl in *].
...
Ltac  musigma gexp hexp :=
  ...
  |  vt (subst_vl ?sigma1 ?sigma0 ?s0)  =>  first [ unify   (subst_tm sigma0 sigma1 (vt s0)) (hexp)|  musigma   (subst_tm sigma0 sigma1 (vt s0)) (hexp) ]
  ...
  |  vt (ren_vl ?sigma1 ?sigma0 ?s0)  =>  first [ unify   (ren_tm sigma0 sigma1 (vt s0)) (hexp)|  musigma   (ren_tm sigma0 sigma1 (vt s0)) (hexp) ]
  |  lam (subst_ty ?sigma0 ?s0) (subst_tm ((scons) (var_vl (var_zero)) ((funcomp) (ren_vl (id) (shift)) ?sigma1)) ?sigma0 ?s1)  =>  first [ unify   (subst_vl sigma0 sigma1 (lam s0 s1)) (hexp)|  musigma   (subst_vl sigma0 sigma1 (lam s0 s1)) (hexp) ]
  |  tlam (subst_tm ((funcomp) (ren_vl (shift) (id)) ?sigma1) ((scons) (var_ty (var_zero)) ((funcomp) (ren_ty (shift)) ?sigma0)) ?s0)  =>  first [ unify   (subst_vl sigma0 sigma1 (tlam s0)) (hexp)|  musigma   (subst_vl sigma0 sigma1 (tlam s0)) (hexp) ]
  |  lam (ren_ty ?sigma0 ?s0) (ren_tm ((scons) (var_zero) ((funcomp) (shift) ?sigma1)) ?sigma0 ?s1)  =>  first [ unify   (ren_vl sigma0 sigma1 (lam s0 s1)) (hexp)|  musigma   (ren_vl sigma0 sigma1 (lam s0 s1)) (hexp) ]
  |  tlam (ren_tm ?sigma1 ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s0)  =>  first [ unify   (ren_vl sigma0 sigma1 (tlam s0)) (hexp)|  musigma   (ren_vl sigma0 sigma1 (tlam s0)) (hexp) ]
  ...
  |  subst_tm ((funcomp) (ren_ty ?tau0) ?sigma0) ((funcomp) (ren_vl ?tau0 ?tau1) ?sigma1) ?s  =>  match   hexp  with
  ...
  |  subst_tm ((funcomp) (subst_ty ?tau0) ?sigma0) ((funcomp) (subst_vl ?tau0 ?tau1) ?sigma1) ?s  =>  match   hexp  with
  ...
  |  ren_vl ((funcomp) ?tau0 ?sigma0) ((funcomp) ?tau1 ?sigma1) ?s  =>  match   hexp  with
  |  ren_vl ?theta0 ?theta1 ?t  =>  first [ unify   (ren_vl tau0 tau1 (ren_vl sigma0 sigma1 s)) (hexp)|  musigma   (ren_vl tau0 tau1 (ren_vl sigma0 sigma1 s)) (hexp) ]
  end
  |  subst_vl ((funcomp) ?tau0 ?sigma0) ((funcomp) ?tau1 ?sigma1) ?s  =>  match   hexp  with
  |  subst_vl ?theta0 ?theta1 ?t  =>  first [ unify   (subst_vl tau0 tau1 (ren_vl sigma0 sigma1 s)) (hexp)|  musigma   (subst_vl tau0 tau1 (ren_vl sigma0 sigma1 s)) (hexp) ]
  end
  |  subst_vl ((funcomp) (ren_ty ?tau0) ?sigma0) ((funcomp) (ren_vl ?tau0 ?tau1) ?sigma1) ?s  =>  match   hexp  with
  |  ren_vl ?theta0 ?theta1 ?t  =>  first [ unify   (ren_vl tau0 tau1 (subst_vl sigma0 sigma1 s)) (hexp)|  musigma   (ren_vl tau0 tau1 (subst_vl sigma0 sigma1 s)) (hexp) ]
  end
  |  subst_vl ((funcomp) (subst_ty ?tau0) ?sigma0) ((funcomp) (subst_vl ?tau0 ?tau1) ?sigma1) ?s  =>  match   hexp  with
  |  subst_vl ?theta0 ?theta1 ?t  =>  first [ unify   (subst_vl tau0 tau1 (subst_vl sigma0 sigma1 s)) (hexp)|  musigma   (subst_vl tau0 tau1 (subst_vl sigma0 sigma1 s)) (hexp) ]
  end
  ...
  |  (funcomp) (subst_tm ((funcomp) (ren_ty ?tau0) ?sigma0) ((funcomp) (ren_vl ?tau0 ?tau1) ?sigma1)) ?sigmas  =>  match   hexp  with
  ...
  |  (funcomp) (subst_tm ((funcomp) (subst_ty ?tau0) ?sigma0) ((funcomp) (subst_vl ?tau0 ?tau1) ?sigma1)) ?sigmas  =>  match   hexp  with
  ...
  |  (funcomp) (ren_vl ((funcomp) ?tau0 ?sigma0) ((funcomp) ?tau1 ?sigma1)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_vl ?theta0 ?theta1) ?sigmat  =>  first [ unify   ((funcomp) (ren_vl tau0 tau1) ((funcomp) (ren_vl sigma0 sigma1) sigmas)) (hexp)|  musigma   ((funcomp) (ren_vl tau0 tau1) ((funcomp) (ren_vl sigma0 sigma1) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_vl ((funcomp) ?tau0 ?sigma0) ((funcomp) ?tau1 ?sigma1)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_vl ?theta0 ?theta1) ?sigmat  =>  first [ unify   ((funcomp) (subst_vl tau0 tau1) ((funcomp) (ren_vl sigma0 sigma1) sigmas)) (hexp)|  musigma   ((funcomp) (subst_vl tau0 tau1) ((funcomp) (ren_vl sigma0 sigma1) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_vl ((funcomp) (ren_ty ?tau0) ?sigma0) ((funcomp) (ren_vl ?tau0 ?tau1) ?sigma1)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_vl ?theta0 ?theta1) ?sigmat  =>  first [ unify   ((funcomp) (ren_vl tau0 tau1) ((funcomp) (subst_vl sigma0 sigma1) sigmas)) (hexp)|  musigma   ((funcomp) (ren_vl tau0 tau1) ((funcomp) (subst_vl sigma0 sigma1) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_vl ((funcomp) (subst_ty ?tau0) ?sigma0) ((funcomp) (subst_vl ?tau0 ?tau1) ?sigma1)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_vl ?theta0 ?theta1) ?sigmat  =>  first [ unify   ((funcomp) (subst_vl tau0 tau1) ((funcomp) (subst_vl sigma0 sigma1) sigmas)) (hexp)|  musigma   ((funcomp) (subst_vl tau0 tau1) ((funcomp) (subst_vl sigma0 sigma1) sigmas)) (hexp) ]
  end
  ...
  |  (scons) (ren_vl ?sigma0 ?sigma1 ?s) ((funcomp) (ren_vl ?sigma0 ?sigma1) ?thetag)  =>  match   hexp  with
  |  (funcomp) (ren_vl ?tau0 ?tau1) ?thetah  =>  first [ unify   ((funcomp) (ren_vl sigma0 sigma1) ((scons) s thetag)) (hexp)|  musigma   ((funcomp) (ren_vl sigma0 sigma1) ((scons) s thetag)) (hexp) ]
  end
  |  (scons) (subst_vl ?sigma0 ?sigma1 ?s) ((funcomp) (subst_vl ?sigma0 ?sigma1) ?thetag)  =>  match   hexp  with
  |  (funcomp) (subst_vl ?tau0 ?tau1) ?thetah  =>  first [ unify   ((funcomp) (subst_vl sigma0 sigma1) ((scons) s thetag)) (hexp)|  musigma   ((funcomp) (subst_vl sigma0 sigma1) ((scons) s thetag)) (hexp) ]
  end
  ...
  |  subst_vl ?sigma0 ?sigma1 ?s  =>  match   hexp  with
  |  subst_vl ?tau0 ?tau1 ?t  =>  musigma   (s) (t); musigma   (sigma0) (tau0); musigma   (sigma1) (tau1)
  end
  |  ren_vl ?sigma0 ?sigma1 ?s  =>  match   hexp  with
  |  ren_vl ?tau0 ?tau1 ?t  =>  musigma   (s) (t); musigma   (sigma0) (tau0); musigma   (sigma1) (tau1)
  end
  |  (funcomp) (subst_vl ?sigma0 ?sigma1) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_vl ?tau0 ?tau1) ?tau  =>  musigma   (sigma) (tau); musigma   (sigma0) (tau0); musigma   (sigma1) (tau1)
  end
  |  (funcomp) (ren_vl ?sigma0 ?sigma1) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_vl ?tau0 ?tau1) ?tau  =>  musigma   (sigma) (tau); musigma   (sigma0) (tau0); musigma   (sigma1) (tau1)
  end
  end.
...
Ltac  heuristics gexp hexp :=
  ...
  |  (funcomp) (subst_tm ((funcomp) var_ty ?sigma0) ((funcomp) var_vl ?sigma1)) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_tm ?tau0 ?tau1) ?tau  =>  let eq := fresh "eq" in
  assert ((funcomp) (subst_tm ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1)) sigma = (funcomp) (ren_tm sigma0 sigma1) sigma) as eq by (renamify; reflexivity); rewrite   (eq); unify   ((funcomp) (ren_tm sigma0 sigma1) sigma) (hexp); clear eq
  end
  |  subst_tm ((funcomp) var_ty ?sigma0) ((funcomp) var_vl ?sigma1) ?s  =>  match   hexp  with
  |  ren_tm ?tau0 ?tau1 ?t  =>  let eq := fresh "eq" in
  assert (subst_tm ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1) s = ren_tm sigma0 sigma1 s) as eq by (renamify; reflexivity); rewrite   (eq); unify   (ren_tm sigma0 sigma1 s) (hexp); clear eq
  end
  |  (funcomp) (subst_vl ((funcomp) var_ty ?sigma0) ((funcomp) var_vl ?sigma1)) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_vl ?tau0 ?tau1) ?tau  =>  let eq := fresh "eq" in
  assert ((funcomp) (subst_vl ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1)) sigma = (funcomp) (ren_vl sigma0 sigma1) sigma) as eq by (renamify; reflexivity); rewrite   (eq); unify   ((funcomp) (ren_vl sigma0 sigma1) sigma) (hexp); clear eq
  end
  |  subst_vl ((funcomp) var_ty ?sigma0) ((funcomp) var_vl ?sigma1) ?s  =>  match   hexp  with
  |  ren_vl ?tau0 ?tau1 ?t  =>  let eq := fresh "eq" in
  assert (subst_vl ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1) s = ren_vl sigma0 sigma1 s) as eq by (renamify; reflexivity); rewrite   (eq); unify   (ren_vl sigma0 sigma1 s) (hexp); clear eq
  end
  |  (funcomp) (ren_ty ?sigma0) ?sigma  =>  match   hexp  with
  ...
  assert ((funcomp) (ren_tm sigma0 sigma1) sigma = (funcomp) (subst_tm ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1)) sigma) as eq by (substify; reflexivity); rewrite   (eq); unify   ((funcomp) (subst_tm ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1)) sigma) (hexp); clear eq
  end
  |  ren_tm ?sigma0 ?sigma1 ?s  =>  match   hexp  with
  |  subst_tm ?tau0 ?tau1 ?t  =>  let eq := fresh "eq" in
  assert (ren_tm sigma0 sigma1 s = subst_tm ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1) s) as eq by (substify; reflexivity); rewrite   (eq); unify   (subst_tm ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1) s) (hexp); clear eq
  end
  |  (funcomp) (ren_vl ?sigma0 ?sigma1) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_vl ?tau0 ?tau1) ?tau  =>  let eq := fresh "eq" in
  assert ((funcomp) (ren_vl sigma0 sigma1) sigma = (funcomp) (subst_vl ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1)) sigma) as eq by (substify; reflexivity); rewrite   (eq); unify   ((funcomp) (subst_vl ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1)) sigma) (hexp); clear eq
  end
  |  ren_vl ?sigma0 ?sigma1 ?s  =>  match   hexp  with
  |  subst_vl ?tau0 ?tau1 ?t  =>  let eq := fresh "eq" in
  assert (ren_vl sigma0 sigma1 s = subst_vl ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1) s) as eq by (substify; reflexivity); rewrite   (eq); unify   (subst_vl ((funcomp) var_ty sigma0) ((funcomp) var_vl sigma1) s) (hexp); clear eq
  end
  |  ?s  =>  musigma   (gexp) (hexp)
  ...
  |  subst_tm ((funcomp) var_ty ?sigmaty) ((scons) ?svl0 ((funcomp) var_vl ?sigmavl)) ?stm  =>  match   hexp  with
  |  subst_tm var_ty ((scons) ?tvl0 var_vl) ?ttm  =>  unify   (subst_tm var_ty ((scons) svl0 var_vl) (ren_tm sigmaty ((scons) (var_zero) ((funcomp) (shift) sigmavl)) stm)) (hexp)
  end
  |  subst_tm ((scons) ?sty0 ((funcomp) var_ty ?sigmaty)) ((funcomp) var_vl ?sigmavl) ?stm  =>  match   hexp  with
  |  subst_tm ((scons) ?tty0 var_ty) var_vl ?ttm  =>  unify   (subst_tm ((scons) sty0 var_ty) var_vl (ren_tm ((scons) (var_zero) ((funcomp) (shift) sigmaty)) sigmavl stm)) (hexp)
  end
  |  subst_tm ?sigmaty ((scons) ?svl0 ?sigmavl) ?stm  =>  match   hexp  with
  |  subst_tm var_ty ((scons) ?tvl0 var_vl) ?ttm  =>  unify   (subst_tm var_ty ((scons) svl0 var_vl) (subst_tm sigmaty ((scons) (var_vl (var_zero)) ((funcomp) (ren_vl (id) (shift)) sigmavl)) stm)) (hexp)
  end
  |  subst_tm ((scons) ?sty0 ?sigmaty) ?sigmavl ?stm  =>  match   hexp  with
  |  subst_tm ((scons) ?tty0 var_ty) var_vl ?ttm  =>  unify   (subst_tm ((scons) sty0 var_ty) var_vl (subst_tm ((scons) (var_ty (var_zero)) ((funcomp) (ren_ty (shift)) sigmaty)) ((funcomp) (ren_vl (shift) (id)) sigmavl) stm)) (hexp)
  end
  |  ?s  =>  match   hexp  with
  |  subst_ty ?sigma0 ?t  =>  unify   (subst_ty var_ty s) (hexp)
  |  ren_ty ?sigma0 ?t  =>  unify   (ren_ty (id) s) (hexp)
  |  subst_tm ?sigma0 ?sigma1 ?t  =>  unify   (subst_tm var_ty var_vl s) (hexp)
  |  ren_tm ?sigma0 ?sigma1 ?t  =>  unify   (ren_tm (id) (id) s) (hexp)
  |  subst_vl ?sigma0 ?sigma1 ?t  =>  unify   (subst_vl var_ty var_vl s) (hexp)
  |  ren_vl ?sigma0 ?sigma1 ?t  =>  unify   (ren_vl (id) (id) s) (hexp)
  end
  |  arr ?s0 ?s1  =>  match   hexp  with
  ...
  |  subst_vl ?sigma0 ?sigma1 ?s  =>  match   hexp  with
  |  subst_vl ?tau0 ?tau1 ?t  =>  heuristics   (s) (t); heuristics   (sigma0) (tau0); heuristics   (sigma1) (tau1)
  end
  |  ren_vl ?sigma0 ?sigma1 ?s  =>  match   hexp  with
  |  ren_vl ?tau0 ?tau1 ?t  =>  heuristics   (s) (t); heuristics   (sigma0) (tau0); heuristics   (sigma1) (tau1)
  end
  |  (funcomp) (subst_vl ?sigma0 ?sigma1) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_vl ?tau0 ?tau1) ?tau  =>  heuristics   (sigma) (tau); heuristics   (sigma0) (tau0); heuristics   (sigma1) (tau1)
  end
  |  (funcomp) (ren_vl ?sigma0 ?sigma1) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_vl ?tau0 ?tau1) ?tau  =>  heuristics   (sigma) (tau); heuristics   (sigma0) (tau0); heuristics   (sigma1) (tau1)
  end
  end.
