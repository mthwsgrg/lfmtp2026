...
Inductive tm (nty ntm : nat) : Type :=
  ...
  | lam4 : tm  ((S) ((S) nty)) (ntm) -> tm (nty) (ntm)
  | con5 : prod (tm  (nty) (ntm)) (tm  (nty) (ntm)) -> tm (nty) (ntm)
  | lam5 : forall (p : nat), tm  (nty) (p + ((S) ntm)) -> tm (nty) (ntm)
  | lam6 : forall (p : nat), tm  (nty) ((S) (p + ntm)) -> tm (nty) (ntm)
  | lam7 : forall (p : nat) (q : nat), tm  (nty) (q + (p + ntm)) -> tm (nty) (ntm)
  | con6 : bool   -> tm  (nty) (ntm) -> tm (nty) (ntm).
...
Lemma congr_lam4 { mty mtm : nat } { s0 : tm  ((S) ((S) mty)) (mtm) } { t0 : tm  ((S) ((S) mty)) (mtm) } (H1 : s0 = t0) : lam4 (mty) (mtm) s0 = lam4 (mty) (mtm) t0 .
Proof. congruence. Qed.

Lemma congr_con5 { mty mtm : nat } { s0 : prod (tm  (mty) (mtm)) (tm  (mty) (mtm)) } { t0 : prod (tm  (mty) (mtm)) (tm  (mty) (mtm)) } (H1 : s0 = t0) : con5 (mty) (mtm) s0 = con5 (mty) (mtm) t0 .
Proof. congruence. Qed.

Lemma congr_lam5 { p : nat } { mty mtm : nat } { s0 : tm  (mty) (p + ((S) mtm)) } { t0 : tm  (mty) (p + ((S) mtm)) } (H1 : s0 = t0) : lam5 (mty) (mtm) p s0 = lam5 (mty) (mtm) p t0 .
Proof. congruence. Qed.

Lemma congr_lam6 { p : nat } { mty mtm : nat } { s0 : tm  (mty) ((S) (p + mtm)) } { t0 : tm  (mty) ((S) (p + mtm)) } (H1 : s0 = t0) : lam6 (mty) (mtm) p s0 = lam6 (mty) (mtm) p t0 .
Proof. congruence. Qed.

Lemma congr_lam7 { p : nat } { q : nat } { mty mtm : nat } { s0 : tm  (mty) (q + (p + mtm)) } { t0 : tm  (mty) (q + (p + mtm)) } (H1 : s0 = t0) : lam7 (mty) (mtm) p q s0 = lam7 (mty) (mtm) p q t0 .
Proof. congruence. Qed.

Lemma congr_con6 { mty mtm : nat } { s0 : bool   } { s1 : tm  (mty) (mtm) } { t0 : bool   } { t1 : tm  (mty) (mtm) } (H1 : s0 = t0) (H2 : s1 = t1) : con6 (mty) (mtm) s0 s1 = con6 (mty) (mtm) t0 t1 .
Proof. congruence. Qed.
...
Fixpoint ren_tm { mty mtm : nat } { nty ntm : nat } (xity : (fin) (mty) -> (fin) (nty)) (xitm : (fin) (mtm) -> (fin) (ntm)) (s : tm (mty) (mtm)) : tm (nty) (ntm) :=
    ...
    | lam3 (_) (_) s0 => lam3 (nty) (ntm) ((list_map (ren_tm (upRen_tm_ty (upRen_ty_ty xity)) (upRen_tm_tm (upRen_ty_tm xitm)))) s0)
    | lam4 (_) (_) s0 => lam4 (nty) (ntm) ((ren_tm (upRen_ty_ty (upRen_ty_ty xity)) (upRen_ty_tm (upRen_ty_tm xitm))) s0)
    | con5 (_) (_) s0 => con5 (nty) (ntm) ((prod_map (ren_tm xity xitm) (ren_tm xity xitm)) s0)
    | lam5 (_) (_) p s0 => lam5 (nty) (ntm) p ((ren_tm (upRenList_tm_ty p (upRen_tm_ty xity)) (upRenList_tm_tm p (upRen_tm_tm xitm))) s0)
    | lam6 (_) (_) p s0 => lam6 (nty) (ntm) p ((ren_tm (upRen_tm_ty (upRenList_tm_ty p xity)) (upRen_tm_tm (upRenList_tm_tm p xitm))) s0)
    | lam7 (_) (_) p q s0 => lam7 (nty) (ntm) p q ((ren_tm (upRenList_tm_ty q (upRenList_tm_ty p xity)) (upRenList_tm_tm q (upRenList_tm_tm p xitm))) s0)
    | con6 (_) (_) s0 s1 => con6 (nty) (ntm) ((fun x => x) s0) ((ren_tm xity xitm) s1)
    end.
...
Fixpoint subst_tm { mty mtm : nat } { nty ntm : nat } (sigmaty : (fin) (mty) -> ty (nty)) (sigmatm : (fin) (mtm) -> tm (nty) (ntm)) (s : tm (mty) (mtm)) : tm (nty) (ntm) :=
    ...
    | lam3 (_) (_) s0 => lam3 (nty) (ntm) ((list_map (subst_tm (up_tm_ty (up_ty_ty sigmaty)) (up_tm_tm (up_ty_tm sigmatm)))) s0)
    | lam4 (_) (_) s0 => lam4 (nty) (ntm) ((subst_tm (up_ty_ty (up_ty_ty sigmaty)) (up_ty_tm (up_ty_tm sigmatm))) s0)
    | con5 (_) (_) s0 => con5 (nty) (ntm) ((prod_map (subst_tm sigmaty sigmatm) (subst_tm sigmaty sigmatm)) s0)
    | lam5 (_) (_) p s0 => lam5 (nty) (ntm) p ((subst_tm (upList_tm_ty p (up_tm_ty sigmaty)) (upList_tm_tm p (up_tm_tm sigmatm))) s0)
    | lam6 (_) (_) p s0 => lam6 (nty) (ntm) p ((subst_tm (up_tm_ty (upList_tm_ty p sigmaty)) (up_tm_tm (upList_tm_tm p sigmatm))) s0)
    | lam7 (_) (_) p q s0 => lam7 (nty) (ntm) p q ((subst_tm (upList_tm_ty q (upList_tm_ty p sigmaty)) (upList_tm_tm q (upList_tm_tm p sigmatm))) s0)
    | con6 (_) (_) s0 s1 => con6 (nty) (ntm) ((fun x => x) s0) ((subst_tm sigmaty sigmatm) s1)
    end.
...
Fixpoint idSubst_tm { mty mtm : nat } (sigmaty : (fin) (mty) -> ty (mty)) (sigmatm : (fin) (mtm) -> tm (mty) (mtm)) (Eqty : forall x, sigmaty x = (var_ty (mty)) x) (Eqtm : forall x, sigmatm x = (var_tm (mty) (mtm)) x) (s : tm (mty) (mtm)) : subst_tm sigmaty sigmatm s = s :=
    ...
    | lam3 (_) (_) s0 => congr_lam3 ((list_id (idSubst_tm (up_tm_ty (up_ty_ty sigmaty)) (up_tm_tm (up_ty_tm sigmatm)) (upId_tm_ty (_) (upId_ty_ty (_) Eqty)) (upId_tm_tm (_) (upId_ty_tm (_) Eqtm)))) s0)
    | lam4 (_) (_) s0 => congr_lam4 ((idSubst_tm (up_ty_ty (up_ty_ty sigmaty)) (up_ty_tm (up_ty_tm sigmatm)) (upId_ty_ty (_) (upId_ty_ty (_) Eqty)) (upId_ty_tm (_) (upId_ty_tm (_) Eqtm))) s0)
    | con5 (_) (_) s0 => congr_con5 ((prod_id (idSubst_tm sigmaty sigmatm Eqty Eqtm) (idSubst_tm sigmaty sigmatm Eqty Eqtm)) s0)
    | lam5 (_) (_) p s0 => congr_lam5 ((idSubst_tm (upList_tm_ty p (up_tm_ty sigmaty)) (upList_tm_tm p (up_tm_tm sigmatm)) (upIdList_tm_ty (_) (upId_tm_ty (_) Eqty)) (upIdList_tm_tm (_) (upId_tm_tm (_) Eqtm))) s0)
    | lam6 (_) (_) p s0 => congr_lam6 ((idSubst_tm (up_tm_ty (upList_tm_ty p sigmaty)) (up_tm_tm (upList_tm_tm p sigmatm)) (upId_tm_ty (_) (upIdList_tm_ty (_) Eqty)) (upId_tm_tm (_) (upIdList_tm_tm (_) Eqtm))) s0)
    | lam7 (_) (_) p q s0 => congr_lam7 ((idSubst_tm (upList_tm_ty q (upList_tm_ty p sigmaty)) (upList_tm_tm q (upList_tm_tm p sigmatm)) (upIdList_tm_ty (_) (upIdList_tm_ty (_) Eqty)) (upIdList_tm_tm (_) (upIdList_tm_tm (_) Eqtm))) s0)
    | con6 (_) (_) s0 s1 => congr_con6 ((fun x => (eq_refl) x) s0) ((idSubst_tm sigmaty sigmatm Eqty Eqtm) s1)
    end.
...
Fixpoint extRen_tm { mty mtm : nat } { nty ntm : nat } (xity : (fin) (mty) -> (fin) (nty)) (xitm : (fin) (mtm) -> (fin) (ntm)) (zetaty : (fin) (mty) -> (fin) (nty)) (zetatm : (fin) (mtm) -> (fin) (ntm)) (Eqty : forall x, xity x = zetaty x) (Eqtm : forall x, xitm x = zetatm x) (s : tm (mty) (mtm)) : ren_tm xity xitm s = ren_tm zetaty zetatm s :=
    ...
    | lam3 (_) (_) s0 => congr_lam3 ((list_ext (extRen_tm (upRen_tm_ty (upRen_ty_ty xity)) (upRen_tm_tm (upRen_ty_tm xitm)) (upRen_tm_ty (upRen_ty_ty zetaty)) (upRen_tm_tm (upRen_ty_tm zetatm)) (upExtRen_tm_ty (_) (_) (upExtRen_ty_ty (_) (_) Eqty)) (upExtRen_tm_tm (_) (_) (upExtRen_ty_tm (_) (_) Eqtm)))) s0)
    | lam4 (_) (_) s0 => congr_lam4 ((extRen_tm (upRen_ty_ty (upRen_ty_ty xity)) (upRen_ty_tm (upRen_ty_tm xitm)) (upRen_ty_ty (upRen_ty_ty zetaty)) (upRen_ty_tm (upRen_ty_tm zetatm)) (upExtRen_ty_ty (_) (_) (upExtRen_ty_ty (_) (_) Eqty)) (upExtRen_ty_tm (_) (_) (upExtRen_ty_tm (_) (_) Eqtm))) s0)
    | con5 (_) (_) s0 => congr_con5 ((prod_ext (extRen_tm xity xitm zetaty zetatm Eqty Eqtm) (extRen_tm xity xitm zetaty zetatm Eqty Eqtm)) s0)
    | lam5 (_) (_) p s0 => congr_lam5 ((extRen_tm (upRenList_tm_ty p (upRen_tm_ty xity)) (upRenList_tm_tm p (upRen_tm_tm xitm)) (upRenList_tm_ty p (upRen_tm_ty zetaty)) (upRenList_tm_tm p (upRen_tm_tm zetatm)) (upExtRen_list_tm_ty (_) (_) (upExtRen_tm_ty (_) (_) Eqty)) (upExtRen_list_tm_tm (_) (_) (upExtRen_tm_tm (_) (_) Eqtm))) s0)
    | lam6 (_) (_) p s0 => congr_lam6 ((extRen_tm (upRen_tm_ty (upRenList_tm_ty p xity)) (upRen_tm_tm (upRenList_tm_tm p xitm)) (upRen_tm_ty (upRenList_tm_ty p zetaty)) (upRen_tm_tm (upRenList_tm_tm p zetatm)) (upExtRen_tm_ty (_) (_) (upExtRen_list_tm_ty (_) (_) Eqty)) (upExtRen_tm_tm (_) (_) (upExtRen_list_tm_tm (_) (_) Eqtm))) s0)
    | lam7 (_) (_) p q s0 => congr_lam7 ((extRen_tm (upRenList_tm_ty q (upRenList_tm_ty p xity)) (upRenList_tm_tm q (upRenList_tm_tm p xitm)) (upRenList_tm_ty q (upRenList_tm_ty p zetaty)) (upRenList_tm_tm q (upRenList_tm_tm p zetatm)) (upExtRen_list_tm_ty (_) (_) (upExtRen_list_tm_ty (_) (_) Eqty)) (upExtRen_list_tm_tm (_) (_) (upExtRen_list_tm_tm (_) (_) Eqtm))) s0)
    | con6 (_) (_) s0 s1 => congr_con6 ((fun x => (eq_refl) x) s0) ((extRen_tm xity xitm zetaty zetatm Eqty Eqtm) s1)
    end.
...
Fixpoint ext_tm { mty mtm : nat } { nty ntm : nat } (sigmaty : (fin) (mty) -> ty (nty)) (sigmatm : (fin) (mtm) -> tm (nty) (ntm)) (tauty : (fin) (mty) -> ty (nty)) (tautm : (fin) (mtm) -> tm (nty) (ntm)) (Eqty : forall x, sigmaty x = tauty x) (Eqtm : forall x, sigmatm x = tautm x) (s : tm (mty) (mtm)) : subst_tm sigmaty sigmatm s = subst_tm tauty tautm s :=
    ...
    | lam3 (_) (_) s0 => congr_lam3 ((list_ext (ext_tm (up_tm_ty (up_ty_ty sigmaty)) (up_tm_tm (up_ty_tm sigmatm)) (up_tm_ty (up_ty_ty tauty)) (up_tm_tm (up_ty_tm tautm)) (upExt_tm_ty (_) (_) (upExt_ty_ty (_) (_) Eqty)) (upExt_tm_tm (_) (_) (upExt_ty_tm (_) (_) Eqtm)))) s0)
    | lam4 (_) (_) s0 => congr_lam4 ((ext_tm (up_ty_ty (up_ty_ty sigmaty)) (up_ty_tm (up_ty_tm sigmatm)) (up_ty_ty (up_ty_ty tauty)) (up_ty_tm (up_ty_tm tautm)) (upExt_ty_ty (_) (_) (upExt_ty_ty (_) (_) Eqty)) (upExt_ty_tm (_) (_) (upExt_ty_tm (_) (_) Eqtm))) s0)
    | con5 (_) (_) s0 => congr_con5 ((prod_ext (ext_tm sigmaty sigmatm tauty tautm Eqty Eqtm) (ext_tm sigmaty sigmatm tauty tautm Eqty Eqtm)) s0)
    | lam5 (_) (_) p s0 => congr_lam5 ((ext_tm (upList_tm_ty p (up_tm_ty sigmaty)) (upList_tm_tm p (up_tm_tm sigmatm)) (upList_tm_ty p (up_tm_ty tauty)) (upList_tm_tm p (up_tm_tm tautm)) (upExt_list_tm_ty (_) (_) (upExt_tm_ty (_) (_) Eqty)) (upExt_list_tm_tm (_) (_) (upExt_tm_tm (_) (_) Eqtm))) s0)
    | lam6 (_) (_) p s0 => congr_lam6 ((ext_tm (up_tm_ty (upList_tm_ty p sigmaty)) (up_tm_tm (upList_tm_tm p sigmatm)) (up_tm_ty (upList_tm_ty p tauty)) (up_tm_tm (upList_tm_tm p tautm)) (upExt_tm_ty (_) (_) (upExt_list_tm_ty (_) (_) Eqty)) (upExt_tm_tm (_) (_) (upExt_list_tm_tm (_) (_) Eqtm))) s0)
    | lam7 (_) (_) p q s0 => congr_lam7 ((ext_tm (upList_tm_ty q (upList_tm_ty p sigmaty)) (upList_tm_tm q (upList_tm_tm p sigmatm)) (upList_tm_ty q (upList_tm_ty p tauty)) (upList_tm_tm q (upList_tm_tm p tautm)) (upExt_list_tm_ty (_) (_) (upExt_list_tm_ty (_) (_) Eqty)) (upExt_list_tm_tm (_) (_) (upExt_list_tm_tm (_) (_) Eqtm))) s0)
    | con6 (_) (_) s0 s1 => congr_con6 ((fun x => (eq_refl) x) s0) ((ext_tm sigmaty sigmatm tauty tautm Eqty Eqtm) s1)
    end.
...
Fixpoint compRenRen_tm { kty ktm : nat } { lty ltm : nat } { mty mtm : nat } (xity : (fin) (mty) -> (fin) (kty)) (xitm : (fin) (mtm) -> (fin) (ktm)) (zetaty : (fin) (kty) -> (fin) (lty)) (zetatm : (fin) (ktm) -> (fin) (ltm)) (rhoty : (fin) (mty) -> (fin) (lty)) (rhotm : (fin) (mtm) -> (fin) (ltm)) (Eqty : forall x, ((funcomp) zetaty xity) x = rhoty x) (Eqtm : forall x, ((funcomp) zetatm xitm) x = rhotm x) (s : tm (mty) (mtm)) : ren_tm zetaty zetatm (ren_tm xity xitm s) = ren_tm rhoty rhotm s :=
    ...
    | lam3 (_) (_) s0 => congr_lam3 ((list_comp (compRenRen_tm (upRen_tm_ty (upRen_ty_ty xity)) (upRen_tm_tm (upRen_ty_tm xitm)) (upRen_tm_ty (upRen_ty_ty zetaty)) (upRen_tm_tm (upRen_ty_tm zetatm)) (upRen_tm_ty (upRen_ty_ty rhoty)) (upRen_tm_tm (upRen_ty_tm rhotm)) (up_ren_ren (_) (_) (_) Eqty) (up_ren_ren (_) (_) (_) Eqtm))) s0)
    | lam4 (_) (_) s0 => congr_lam4 ((compRenRen_tm (upRen_ty_ty (upRen_ty_ty xity)) (upRen_ty_tm (upRen_ty_tm xitm)) (upRen_ty_ty (upRen_ty_ty zetaty)) (upRen_ty_tm (upRen_ty_tm zetatm)) (upRen_ty_ty (upRen_ty_ty rhoty)) (upRen_ty_tm (upRen_ty_tm rhotm)) (up_ren_ren (_) (_) (_) (up_ren_ren (_) (_) (_) Eqty)) Eqtm) s0)
    | con5 (_) (_) s0 => congr_con5 ((prod_comp (compRenRen_tm xity xitm zetaty zetatm rhoty rhotm Eqty Eqtm) (compRenRen_tm xity xitm zetaty zetatm rhoty rhotm Eqty Eqtm)) s0)
    | lam5 (_) (_) p s0 => congr_lam5 ((compRenRen_tm (upRenList_tm_ty p (upRen_tm_ty xity)) (upRenList_tm_tm p (upRen_tm_tm xitm)) (upRenList_tm_ty p (upRen_tm_ty zetaty)) (upRenList_tm_tm p (upRen_tm_tm zetatm)) (upRenList_tm_ty p (upRen_tm_ty rhoty)) (upRenList_tm_tm p (upRen_tm_tm rhotm)) Eqty (up_ren_ren_p (up_ren_ren (_) (_) (_) Eqtm))) s0)
    | lam6 (_) (_) p s0 => congr_lam6 ((compRenRen_tm (upRen_tm_ty (upRenList_tm_ty p xity)) (upRen_tm_tm (upRenList_tm_tm p xitm)) (upRen_tm_ty (upRenList_tm_ty p zetaty)) (upRen_tm_tm (upRenList_tm_tm p zetatm)) (upRen_tm_ty (upRenList_tm_ty p rhoty)) (upRen_tm_tm (upRenList_tm_tm p rhotm)) Eqty (up_ren_ren (_) (_) (_) (up_ren_ren_p Eqtm))) s0)
    | lam7 (_) (_) p q s0 => congr_lam7 ((compRenRen_tm (upRenList_tm_ty q (upRenList_tm_ty p xity)) (upRenList_tm_tm q (upRenList_tm_tm p xitm)) (upRenList_tm_ty q (upRenList_tm_ty p zetaty)) (upRenList_tm_tm q (upRenList_tm_tm p zetatm)) (upRenList_tm_ty q (upRenList_tm_ty p rhoty)) (upRenList_tm_tm q (upRenList_tm_tm p rhotm)) Eqty (up_ren_ren_p (up_ren_ren_p Eqtm))) s0)
    | con6 (_) (_) s0 s1 => congr_con6 ((fun x => (eq_refl) x) s0) ((compRenRen_tm xity xitm zetaty zetatm rhoty rhotm Eqty Eqtm) s1)
    end.
...
Fixpoint compRenSubst_tm { kty ktm : nat } { lty ltm : nat } { mty mtm : nat } (xity : (fin) (mty) -> (fin) (kty)) (xitm : (fin) (mtm) -> (fin) (ktm)) (tauty : (fin) (kty) -> ty (lty)) (tautm : (fin) (ktm) -> tm (lty) (ltm)) (thetaty : (fin) (mty) -> ty (lty)) (thetatm : (fin) (mtm) -> tm (lty) (ltm)) (Eqty : forall x, ((funcomp) tauty xity) x = thetaty x) (Eqtm : forall x, ((funcomp) tautm xitm) x = thetatm x) (s : tm (mty) (mtm)) : subst_tm tauty tautm (ren_tm xity xitm s) = subst_tm thetaty thetatm s :=
    ...
    | lam3 (_) (_) s0 => congr_lam3 ((list_comp (compRenSubst_tm (upRen_tm_ty (upRen_ty_ty xity)) (upRen_tm_tm (upRen_ty_tm xitm)) (up_tm_ty (up_ty_ty tauty)) (up_tm_tm (up_ty_tm tautm)) (up_tm_ty (up_ty_ty thetaty)) (up_tm_tm (up_ty_tm thetatm)) (up_ren_subst_tm_ty (_) (_) (_) (up_ren_subst_ty_ty (_) (_) (_) Eqty)) (up_ren_subst_tm_tm (_) (_) (_) (up_ren_subst_ty_tm (_) (_) (_) Eqtm)))) s0)
    | lam4 (_) (_) s0 => congr_lam4 ((compRenSubst_tm (upRen_ty_ty (upRen_ty_ty xity)) (upRen_ty_tm (upRen_ty_tm xitm)) (up_ty_ty (up_ty_ty tauty)) (up_ty_tm (up_ty_tm tautm)) (up_ty_ty (up_ty_ty thetaty)) (up_ty_tm (up_ty_tm thetatm)) (up_ren_subst_ty_ty (_) (_) (_) (up_ren_subst_ty_ty (_) (_) (_) Eqty)) (up_ren_subst_ty_tm (_) (_) (_) (up_ren_subst_ty_tm (_) (_) (_) Eqtm))) s0)
    | con5 (_) (_) s0 => congr_con5 ((prod_comp (compRenSubst_tm xity xitm tauty tautm thetaty thetatm Eqty Eqtm) (compRenSubst_tm xity xitm tauty tautm thetaty thetatm Eqty Eqtm)) s0)
    | lam5 (_) (_) p s0 => congr_lam5 ((compRenSubst_tm (upRenList_tm_ty p (upRen_tm_ty xity)) (upRenList_tm_tm p (upRen_tm_tm xitm)) (upList_tm_ty p (up_tm_ty tauty)) (upList_tm_tm p (up_tm_tm tautm)) (upList_tm_ty p (up_tm_ty thetaty)) (upList_tm_tm p (up_tm_tm thetatm)) (up_ren_subst_list_tm_ty (_) (_) (_) (up_ren_subst_tm_ty (_) (_) (_) Eqty)) (up_ren_subst_list_tm_tm (_) (_) (_) (up_ren_subst_tm_tm (_) (_) (_) Eqtm))) s0)
    | lam6 (_) (_) p s0 => congr_lam6 ((compRenSubst_tm (upRen_tm_ty (upRenList_tm_ty p xity)) (upRen_tm_tm (upRenList_tm_tm p xitm)) (up_tm_ty (upList_tm_ty p tauty)) (up_tm_tm (upList_tm_tm p tautm)) (up_tm_ty (upList_tm_ty p thetaty)) (up_tm_tm (upList_tm_tm p thetatm)) (up_ren_subst_tm_ty (_) (_) (_) (up_ren_subst_list_tm_ty (_) (_) (_) Eqty)) (up_ren_subst_tm_tm (_) (_) (_) (up_ren_subst_list_tm_tm (_) (_) (_) Eqtm))) s0)
    | lam7 (_) (_) p q s0 => congr_lam7 ((compRenSubst_tm (upRenList_tm_ty q (upRenList_tm_ty p xity)) (upRenList_tm_tm q (upRenList_tm_tm p xitm)) (upList_tm_ty q (upList_tm_ty p tauty)) (upList_tm_tm q (upList_tm_tm p tautm)) (upList_tm_ty q (upList_tm_ty p thetaty)) (upList_tm_tm q (upList_tm_tm p thetatm)) (up_ren_subst_list_tm_ty (_) (_) (_) (up_ren_subst_list_tm_ty (_) (_) (_) Eqty)) (up_ren_subst_list_tm_tm (_) (_) (_) (up_ren_subst_list_tm_tm (_) (_) (_) Eqtm))) s0)
    | con6 (_) (_) s0 s1 => congr_con6 ((fun x => (eq_refl) x) s0) ((compRenSubst_tm xity xitm tauty tautm thetaty thetatm Eqty Eqtm) s1)
    end.
...
Fixpoint compSubstRen_tm { kty ktm : nat } { lty ltm : nat } { mty mtm : nat } (sigmaty : (fin) (mty) -> ty (kty)) (sigmatm : (fin) (mtm) -> tm (kty) (ktm)) (zetaty : (fin) (kty) -> (fin) (lty)) (zetatm : (fin) (ktm) -> (fin) (ltm)) (thetaty : (fin) (mty) -> ty (lty)) (thetatm : (fin) (mtm) -> tm (lty) (ltm)) (Eqty : forall x, ((funcomp) (ren_ty zetaty) sigmaty) x = thetaty x) (Eqtm : forall x, ((funcomp) (ren_tm zetaty zetatm) sigmatm) x = thetatm x) (s : tm (mty) (mtm)) : ren_tm zetaty zetatm (subst_tm sigmaty sigmatm s) = subst_tm thetaty thetatm s :=
    ...
    | lam3 (_) (_) s0 => congr_lam3 ((list_comp (compSubstRen_tm (up_tm_ty (up_ty_ty sigmaty)) (up_tm_tm (up_ty_tm sigmatm)) (upRen_tm_ty (upRen_ty_ty zetaty)) (upRen_tm_tm (upRen_ty_tm zetatm)) (up_tm_ty (up_ty_ty thetaty)) (up_tm_tm (up_ty_tm thetatm)) (up_subst_ren_tm_ty (_) (_) (_) (up_subst_ren_ty_ty (_) (_) (_) Eqty)) (up_subst_ren_tm_tm (_) (_) (_) (_) (up_subst_ren_ty_tm (_) (_) (_) (_) Eqtm)))) s0)
    | lam4 (_) (_) s0 => congr_lam4 ((compSubstRen_tm (up_ty_ty (up_ty_ty sigmaty)) (up_ty_tm (up_ty_tm sigmatm)) (upRen_ty_ty (upRen_ty_ty zetaty)) (upRen_ty_tm (upRen_ty_tm zetatm)) (up_ty_ty (up_ty_ty thetaty)) (up_ty_tm (up_ty_tm thetatm)) (up_subst_ren_ty_ty (_) (_) (_) (up_subst_ren_ty_ty (_) (_) (_) Eqty)) (up_subst_ren_ty_tm (_) (_) (_) (_) (up_subst_ren_ty_tm (_) (_) (_) (_) Eqtm))) s0)
    | con5 (_) (_) s0 => congr_con5 ((prod_comp (compSubstRen_tm sigmaty sigmatm zetaty zetatm thetaty thetatm Eqty Eqtm) (compSubstRen_tm sigmaty sigmatm zetaty zetatm thetaty thetatm Eqty Eqtm)) s0)
    | lam5 (_) (_) p s0 => congr_lam5 ((compSubstRen_tm (upList_tm_ty p (up_tm_ty sigmaty)) (upList_tm_tm p (up_tm_tm sigmatm)) (upRenList_tm_ty p (upRen_tm_ty zetaty)) (upRenList_tm_tm p (upRen_tm_tm zetatm)) (upList_tm_ty p (up_tm_ty thetaty)) (upList_tm_tm p (up_tm_tm thetatm)) (up_subst_ren_list_tm_ty (_) (_) (_) (up_subst_ren_tm_ty (_) (_) (_) Eqty)) (up_subst_ren_list_tm_tm (_) (_) (_) (_) (up_subst_ren_tm_tm (_) (_) (_) (_) Eqtm))) s0)
    | lam6 (_) (_) p s0 => congr_lam6 ((compSubstRen_tm (up_tm_ty (upList_tm_ty p sigmaty)) (up_tm_tm (upList_tm_tm p sigmatm)) (upRen_tm_ty (upRenList_tm_ty p zetaty)) (upRen_tm_tm (upRenList_tm_tm p zetatm)) (up_tm_ty (upList_tm_ty p thetaty)) (up_tm_tm (upList_tm_tm p thetatm)) (up_subst_ren_tm_ty (_) (_) (_) (up_subst_ren_list_tm_ty (_) (_) (_) Eqty)) (up_subst_ren_tm_tm (_) (_) (_) (_) (up_subst_ren_list_tm_tm (_) (_) (_) (_) Eqtm))) s0)
    | lam7 (_) (_) p q s0 => congr_lam7 ((compSubstRen_tm (upList_tm_ty q (upList_tm_ty p sigmaty)) (upList_tm_tm q (upList_tm_tm p sigmatm)) (upRenList_tm_ty q (upRenList_tm_ty p zetaty)) (upRenList_tm_tm q (upRenList_tm_tm p zetatm)) (upList_tm_ty q (upList_tm_ty p thetaty)) (upList_tm_tm q (upList_tm_tm p thetatm)) (up_subst_ren_list_tm_ty (_) (_) (_) (up_subst_ren_list_tm_ty (_) (_) (_) Eqty)) (up_subst_ren_list_tm_tm (_) (_) (_) (_) (up_subst_ren_list_tm_tm (_) (_) (_) (_) Eqtm))) s0)
    | con6 (_) (_) s0 s1 => congr_con6 ((fun x => (eq_refl) x) s0) ((compSubstRen_tm sigmaty sigmatm zetaty zetatm thetaty thetatm Eqty Eqtm) s1)
    end.
...
Fixpoint compSubstSubst_tm { kty ktm : nat } { lty ltm : nat } { mty mtm : nat } (sigmaty : (fin) (mty) -> ty (kty)) (sigmatm : (fin) (mtm) -> tm (kty) (ktm)) (tauty : (fin) (kty) -> ty (lty)) (tautm : (fin) (ktm) -> tm (lty) (ltm)) (thetaty : (fin) (mty) -> ty (lty)) (thetatm : (fin) (mtm) -> tm (lty) (ltm)) (Eqty : forall x, ((funcomp) (subst_ty tauty) sigmaty) x = thetaty x) (Eqtm : forall x, ((funcomp) (subst_tm tauty tautm) sigmatm) x = thetatm x) (s : tm (mty) (mtm)) : subst_tm tauty tautm (subst_tm sigmaty sigmatm s) = subst_tm thetaty thetatm s :=
    ...
    | lam3 (_) (_) s0 => congr_lam3 ((list_comp (compSubstSubst_tm (up_tm_ty (up_ty_ty sigmaty)) (up_tm_tm (up_ty_tm sigmatm)) (up_tm_ty (up_ty_ty tauty)) (up_tm_tm (up_ty_tm tautm)) (up_tm_ty (up_ty_ty thetaty)) (up_tm_tm (up_ty_tm thetatm)) (up_subst_subst_tm_ty (_) (_) (_) (up_subst_subst_ty_ty (_) (_) (_) Eqty)) (up_subst_subst_tm_tm (_) (_) (_) (_) (up_subst_subst_ty_tm (_) (_) (_) (_) Eqtm)))) s0)
    | lam4 (_) (_) s0 => congr_lam4 ((compSubstSubst_tm (up_ty_ty (up_ty_ty sigmaty)) (up_ty_tm (up_ty_tm sigmatm)) (up_ty_ty (up_ty_ty tauty)) (up_ty_tm (up_ty_tm tautm)) (up_ty_ty (up_ty_ty thetaty)) (up_ty_tm (up_ty_tm thetatm)) (up_subst_subst_ty_ty (_) (_) (_) (up_subst_subst_ty_ty (_) (_) (_) Eqty)) (up_subst_subst_ty_tm (_) (_) (_) (_) (up_subst_subst_ty_tm (_) (_) (_) (_) Eqtm))) s0)
    | con5 (_) (_) s0 => congr_con5 ((prod_comp (compSubstSubst_tm sigmaty sigmatm tauty tautm thetaty thetatm Eqty Eqtm) (compSubstSubst_tm sigmaty sigmatm tauty tautm thetaty thetatm Eqty Eqtm)) s0)
    | lam5 (_) (_) p s0 => congr_lam5 ((compSubstSubst_tm (upList_tm_ty p (up_tm_ty sigmaty)) (upList_tm_tm p (up_tm_tm sigmatm)) (upList_tm_ty p (up_tm_ty tauty)) (upList_tm_tm p (up_tm_tm tautm)) (upList_tm_ty p (up_tm_ty thetaty)) (upList_tm_tm p (up_tm_tm thetatm)) (up_subst_subst_list_tm_ty (_) (_) (_) (up_subst_subst_tm_ty (_) (_) (_) Eqty)) (up_subst_subst_list_tm_tm (_) (_) (_) (_) (up_subst_subst_tm_tm (_) (_) (_) (_) Eqtm))) s0)
    | lam6 (_) (_) p s0 => congr_lam6 ((compSubstSubst_tm (up_tm_ty (upList_tm_ty p sigmaty)) (up_tm_tm (upList_tm_tm p sigmatm)) (up_tm_ty (upList_tm_ty p tauty)) (up_tm_tm (upList_tm_tm p tautm)) (up_tm_ty (upList_tm_ty p thetaty)) (up_tm_tm (upList_tm_tm p thetatm)) (up_subst_subst_tm_ty (_) (_) (_) (up_subst_subst_list_tm_ty (_) (_) (_) Eqty)) (up_subst_subst_tm_tm (_) (_) (_) (_) (up_subst_subst_list_tm_tm (_) (_) (_) (_) Eqtm))) s0)
    | lam7 (_) (_) p q s0 => congr_lam7 ((compSubstSubst_tm (upList_tm_ty q (upList_tm_ty p sigmaty)) (upList_tm_tm q (upList_tm_tm p sigmatm)) (upList_tm_ty q (upList_tm_ty p tauty)) (upList_tm_tm q (upList_tm_tm p tautm)) (upList_tm_ty q (upList_tm_ty p thetaty)) (upList_tm_tm q (upList_tm_tm p thetatm)) (up_subst_subst_list_tm_ty (_) (_) (_) (up_subst_subst_list_tm_ty (_) (_) (_) Eqty)) (up_subst_subst_list_tm_tm (_) (_) (_) (_) (up_subst_subst_list_tm_tm (_) (_) (_) (_) Eqtm))) s0)
    | con6 (_) (_) s0 s1 => congr_con6 ((fun x => (eq_refl) x) s0) ((compSubstSubst_tm sigmaty sigmatm tauty tautm thetaty thetatm Eqty Eqtm) s1)
    end.
...
Fixpoint rinst_inst_tm { mty mtm : nat } { nty ntm : nat } (xity : (fin) (mty) -> (fin) (nty)) (xitm : (fin) (mtm) -> (fin) (ntm)) (sigmaty : (fin) (mty) -> ty (nty)) (sigmatm : (fin) (mtm) -> tm (nty) (ntm)) (Eqty : forall x, ((funcomp) (var_ty (nty)) xity) x = sigmaty x) (Eqtm : forall x, ((funcomp) (var_tm (nty) (ntm)) xitm) x = sigmatm x) (s : tm (mty) (mtm)) : ren_tm xity xitm s = subst_tm sigmaty sigmatm s :=
    ...
    | lam3 (_) (_) s0 => congr_lam3 ((list_ext (rinst_inst_tm (upRen_tm_ty (upRen_ty_ty xity)) (upRen_tm_tm (upRen_ty_tm xitm)) (up_tm_ty (up_ty_ty sigmaty)) (up_tm_tm (up_ty_tm sigmatm)) (rinstInst_up_tm_ty (_) (_) (rinstInst_up_ty_ty (_) (_) Eqty)) (rinstInst_up_tm_tm (_) (_) (rinstInst_up_ty_tm (_) (_) Eqtm)))) s0)
    | lam4 (_) (_) s0 => congr_lam4 ((rinst_inst_tm (upRen_ty_ty (upRen_ty_ty xity)) (upRen_ty_tm (upRen_ty_tm xitm)) (up_ty_ty (up_ty_ty sigmaty)) (up_ty_tm (up_ty_tm sigmatm)) (rinstInst_up_ty_ty (_) (_) (rinstInst_up_ty_ty (_) (_) Eqty)) (rinstInst_up_ty_tm (_) (_) (rinstInst_up_ty_tm (_) (_) Eqtm))) s0)
    | con5 (_) (_) s0 => congr_con5 ((prod_ext (rinst_inst_tm xity xitm sigmaty sigmatm Eqty Eqtm) (rinst_inst_tm xity xitm sigmaty sigmatm Eqty Eqtm)) s0)
    | lam5 (_) (_) p s0 => congr_lam5 ((rinst_inst_tm (upRenList_tm_ty p (upRen_tm_ty xity)) (upRenList_tm_tm p (upRen_tm_tm xitm)) (upList_tm_ty p (up_tm_ty sigmaty)) (upList_tm_tm p (up_tm_tm sigmatm)) (rinstInst_up_list_tm_ty (_) (_) (rinstInst_up_tm_ty (_) (_) Eqty)) (rinstInst_up_list_tm_tm (_) (_) (rinstInst_up_tm_tm (_) (_) Eqtm))) s0)
    | lam6 (_) (_) p s0 => congr_lam6 ((rinst_inst_tm (upRen_tm_ty (upRenList_tm_ty p xity)) (upRen_tm_tm (upRenList_tm_tm p xitm)) (up_tm_ty (upList_tm_ty p sigmaty)) (up_tm_tm (upList_tm_tm p sigmatm)) (rinstInst_up_tm_ty (_) (_) (rinstInst_up_list_tm_ty (_) (_) Eqty)) (rinstInst_up_tm_tm (_) (_) (rinstInst_up_list_tm_tm (_) (_) Eqtm))) s0)
    | lam7 (_) (_) p q s0 => congr_lam7 ((rinst_inst_tm (upRenList_tm_ty q (upRenList_tm_ty p xity)) (upRenList_tm_tm q (upRenList_tm_tm p xitm)) (upList_tm_ty q (upList_tm_ty p sigmaty)) (upList_tm_tm q (upList_tm_tm p sigmatm)) (rinstInst_up_list_tm_ty (_) (_) (rinstInst_up_list_tm_ty (_) (_) Eqty)) (rinstInst_up_list_tm_tm (_) (_) (rinstInst_up_list_tm_tm (_) (_) Eqtm))) s0)
    | con6 (_) (_) s0 s1 => congr_con6 ((fun x => (eq_refl) x) s0) ((rinst_inst_tm xity xitm sigmaty sigmatm Eqty Eqtm) s1)
    end.
...
Arguments lam4 {nty} {ntm}.

Arguments con5 {nty} {ntm}.

Arguments lam5 {nty} {ntm}.

Arguments lam6 {nty} {ntm}.

Arguments lam7 {nty} {ntm}.

Arguments con6 {nty} {ntm}.
...
Tactic Notation "asimpl" "in" "*" := auto_unfold in *; repeat first [progress rewrite ?instId_ty in *| progress rewrite ?compComp_ty in *| progress rewrite ?compComp'_ty in *| progress rewrite ?instId_tm in *| progress rewrite ?compComp_tm in *| progress rewrite ?compComp'_tm in *| progress rewrite ?rinstId_ty in *| progress rewrite ?compRen_ty in *| progress rewrite ?compRen'_ty in *| progress rewrite ?renComp_ty in *| progress rewrite ?renComp'_ty in *| progress rewrite ?renRen_ty in *| progress rewrite ?renRen'_ty in *| progress rewrite ?rinstId_tm in *| progress rewrite ?compRen_tm in *| progress rewrite ?compRen'_tm in *| progress rewrite ?renComp_tm in *| progress rewrite ?renComp'_tm in *| progress rewrite ?renRen_tm in *| progress rewrite ?renRen'_tm in *| progress rewrite ?varL_ty in *| progress rewrite ?varL_tm in *| progress rewrite ?varLRen_ty in *| progress rewrite ?varLRen_tm in *| progress (unfold up_ren, upRen_ty_ty, upRen_tm_ty, upRen_tm_tm, upRen_ty_tm, upRenList_tm_ty, upRenList_tm_tm, upRenList_tm_ty, upRenList_tm_tm, up_ty_ty, up_tm_ty, up_tm_tm, up_ty_tm, upList_tm_ty, upList_tm_tm, upList_tm_ty, upList_tm_tm in *)| progress (cbn [subst_ty subst_tm ren_ty ren_tm] in *)| fsimpl in *].
...
Ltac  musigma gexp hexp :=
  ...
  |  lam4 (subst_tm ((funcomp) (ren_tm ((funcomp) (shift) (shift)) (id)) ?sigma1) ((scons) (var_ty (var_zero)) ((scons) (var_ty ((shift) (var_zero))) ((funcomp) (ren_ty ((funcomp) (shift) (shift))) ?sigma0))) ?s0)  =>  first [ unify   (subst_tm sigma0 sigma1 (lam4 s0)) (hexp)|  musigma   (subst_tm sigma0 sigma1 (lam4 s0)) (hexp) ]
  |  con5 (prod_map (subst_tm ?sigma1 ?sigma0) (subst_tm ?sigma1 ?sigma0) ?s0)  =>  first [ unify   (subst_tm sigma0 sigma1 (con5 s0)) (hexp)|  musigma   (subst_tm sigma0 sigma1 (con5 s0)) (hexp) ]
  |  lam5 ?p (subst_tm (scons_p ?p ((funcomp) var_tm (zero_p ?p)) ((scons) (var_tm (shift_p ?p (var_zero))) ((funcomp) (ren_tm (id) ((funcomp) (shift_p ?p) (shift))) ?sigma1))) ?sigma0 ?s0)  =>  first [ unify   (subst_tm sigma0 sigma1 (lam5 p s0)) (hexp)|  musigma   (subst_tm sigma0 sigma1 (lam5 p s0)) (hexp) ]
  |  lam6 ?p (subst_tm ((scons) (var_tm (var_zero)) (scons_p ?p ((funcomp) ((funcomp) var_tm (shift)) (zero_p ?p)) ((funcomp) (ren_tm (id) ((funcomp) (shift) (shift_p ?p))) ?sigma1))) ?sigma0 ?s0)  =>  first [ unify   (subst_tm sigma0 sigma1 (lam6 p s0)) (hexp)|  musigma   (subst_tm sigma0 sigma1 (lam6 p s0)) (hexp) ]
  |  lam7 ?p ?q (subst_tm (scons_p ?q ((funcomp) var_tm (zero_p ?q)) (scons_p ?p ((funcomp) ((funcomp) var_tm (shift_p ?q)) (zero_p ?p)) ((funcomp) (ren_tm (id) ((funcomp) (shift_p ?q) (shift_p ?p))) ?sigma1))) ?sigma0 ?s0)  =>  first [ unify   (subst_tm sigma0 sigma1 (lam7 p q s0)) (hexp)|  musigma   (subst_tm sigma0 sigma1 (lam7 p q s0)) (hexp) ]
  |  con6 ((fun x => x) ?s0) (subst_tm ?sigma1 ?sigma0 ?s1)  =>  first [ unify   (subst_tm sigma0 sigma1 (con6 s0 s1)) (hexp)|  musigma   (subst_tm sigma0 sigma1 (con6 s0 s1)) (hexp) ]
  ...
  |  lam4 (ren_tm ?sigma1 ((scons) (var_zero) ((scons) ((shift) (var_zero)) ((funcomp) ((funcomp) (shift) (shift)) ?sigma0))) ?s0)  =>  first [ unify   (ren_tm sigma0 sigma1 (lam4 s0)) (hexp)|  musigma   (ren_tm sigma0 sigma1 (lam4 s0)) (hexp) ]
  |  con5 (prod_map (ren_tm ?sigma1 ?sigma0) (ren_tm ?sigma1 ?sigma0) ?s0)  =>  first [ unify   (ren_tm sigma0 sigma1 (con5 s0)) (hexp)|  musigma   (ren_tm sigma0 sigma1 (con5 s0)) (hexp) ]
  |  lam5 ?p (ren_tm (scons_p ?p (zero_p ?p) ((scons) (shift_p ?p (var_zero)) ((funcomp) ((funcomp) (shift) (shift_p ?p)) ?sigma1))) ?sigma0 ?s0)  =>  first [ unify   (ren_tm sigma0 sigma1 (lam5 p s0)) (hexp)|  musigma   (ren_tm sigma0 sigma1 (lam5 p s0)) (hexp) ]
  |  lam6 ?p (ren_tm ((scons) (var_zero) (scons_p ?p ((funcomp) (shift) (zero_p ?p)) ((funcomp) ((shift) (shift_p ?p) (shift)) ?sigma1))) ?sigma0 ?s0)  =>  first [ unify   (ren_tm sigma0 sigma1 (lam6 p s0)) (hexp)|  musigma   (ren_tm sigma0 sigma1 (lam6 p s0)) (hexp) ]
  |  lam7 ?p ?q (ren_tm (scons_p ?q (zero_p ?q) (scons_p ?p ((funcomp) (shift_p ?q) (zero_p ?p)) ((funcomp) ((funcomp) (shift_p ?p) (shift_p ?q)) ?sigma1))) ?sigma0 ?s0)  =>  first [ unify   (ren_tm sigma0 sigma1 (lam7 p q s0)) (hexp)|  musigma   (ren_tm sigma0 sigma1 (lam7 p q s0)) (hexp) ]
  |  con6 ((fun x => x) ?s0) (ren_tm ?sigma1 ?sigma0 ?s1)  =>  first [ unify   (ren_tm sigma0 sigma1 (con6 s0 s1)) (hexp)|  musigma   (ren_tm sigma0 sigma1 (con6 s0 s1)) (hexp) ]
  ...
  |  lam4 ?s0  =>  match   hexp  with
  |  lam4 ?t0  =>  musigma   (s0) (t0)
  end
  |  con5 ?s0  =>  match   hexp  with
  |  con5 ?t0  =>  musigma   (s0) (t0)
  end
  |  lam5 ?p ?s0  =>  match   hexp  with
  |  lam5 ?p_ ?t0  =>  musigma   (p) (p_); musigma   (s0) (t0)
  end
  |  lam6 ?p ?s0  =>  match   hexp  with
  |  lam6 ?p_ ?t0  =>  musigma   (p) (p_); musigma   (s0) (t0)
  end
  |  lam7 ?p ?q ?s0  =>  match   hexp  with
  |  lam7 ?p_ ?q_ ?t0  =>  musigma   (p) (p_); musigma   (q) (q_); musigma   (s0) (t0)
  end
  |  con6 ?s0 ?s1  =>  match   hexp  with
  |  con6 ?t0 ?t1  =>  musigma   (s0) (t0); musigma   (s1) (t1)
  end
...
Ltac  heuristics gexp hexp :=
  ...
  |  subst_tm ((scons) ?sty1 ((scons) ?sty0 ((funcomp) var_ty ?sigmaty))) ((funcomp) var_tm ?sigmatm) ?stm  =>  match   hexp  with
  |  subst_tm ((scons) ?tty1 ((scons) ?tty0 var_ty)) var_tm ?ttm  =>  unify   (subst_tm ((scons) sty1 ((scons) sty0 var_ty)) var_tm (ren_tm ((scons) (var_zero) ((scons) ((shift) (var_zero)) ((funcomp) ((funcomp) (shift) (shift)) sigmaty))) sigmatm stm)) (hexp)
  end
  |  subst_tm ((funcomp) var_ty ?sigmaty) (scons_p ?p ?stm1 ((scons) ?stm0 ((funcomp) var_tm ?sigmatm))) ?stm  =>  match   hexp  with
  |  subst_tm var_ty (scons_p ?p_ ?ttm1 ((scons) ?ttm0 var_tm)) ?ttm  =>  unify   (subst_tm var_ty (scons_p p stm1 ((scons) stm0 var_tm)) (ren_tm sigmaty (scons_p p (zero_p p) ((scons) (shift_p p (var_zero)) ((funcomp) ((funcomp) (shift) (shift_p p)) sigmatm))) stm)) (hexp)
  end
  |  subst_tm ((funcomp) var_ty ?sigmaty) ((scons) ?stm1 (scons_p ?p ?stm0 ((funcomp) var_tm ?sigmatm))) ?stm  =>  match   hexp  with
  |  subst_tm var_ty ((scons) ?ttm1 (scons_p ?p_ ?ttm0 var_tm)) ?ttm  =>  unify   (subst_tm var_ty ((scons) stm1 (scons_p p stm0 var_tm)) (ren_tm sigmaty ((scons) (var_zero) (scons_p p ((funcomp) (shift) (zero_p p)) ((funcomp) ((shift) (shift_p p) (shift)) sigmatm))) stm)) (hexp)
  end
  |  subst_tm ((funcomp) var_ty ?sigmaty) (scons_p ?q ?stm1 (scons_p ?p ?stm0 ((funcomp) var_tm ?sigmatm))) ?stm  =>  match   hexp  with
  |  subst_tm var_ty (scons_p ?q_ ?ttm1 (scons_p ?p_ ?ttm0 var_tm)) ?ttm  =>  unify   (subst_tm var_ty (scons_p q stm1 (scons_p p stm0 var_tm)) (ren_tm sigmaty (scons_p q (zero_p q) (scons_p p ((funcomp) (shift_p q) (zero_p p)) ((funcomp) ((funcomp) (shift_p p) (shift_p q)) sigmatm))) stm)) (hexp)
  end
  ...
  |  subst_tm ((scons) ?sty1 ((scons) ?sty0 ?sigmaty)) ?sigmatm ?stm  =>  match   hexp  with
  |  subst_tm ((scons) ?tty1 ((scons) ?tty0 var_ty)) var_tm ?ttm  =>  unify   (subst_tm ((scons) sty1 ((scons) sty0 var_ty)) var_tm (subst_tm ((scons) (var_ty (var_zero)) ((scons) (var_ty ((shift) (var_zero))) ((funcomp) (ren_ty ((funcomp) (shift) (shift))) sigmaty))) ((funcomp) (ren_tm ((funcomp) (shift) (shift)) (id)) sigmatm) stm)) (hexp)
  end
  |  subst_tm ?sigmaty (scons_p ?p ?stm1 ((scons) ?stm0 ?sigmatm)) ?stm  =>  match   hexp  with
  |  subst_tm var_ty (scons_p ?p_ ?ttm1 ((scons) ?ttm0 var_tm)) ?ttm  =>  unify   (subst_tm var_ty (scons_p p stm1 ((scons) stm0 var_tm)) (subst_tm sigmaty (scons_p p ((funcomp) var_tm (zero_p p)) ((scons) (var_tm (shift_p p (var_zero))) ((funcomp) (ren_tm (id) ((funcomp) (shift_p p) (shift))) sigmatm))) stm)) (hexp)
  end
  |  subst_tm ?sigmaty ((scons) ?stm1 (scons_p ?p ?stm0 ?sigmatm)) ?stm  =>  match   hexp  with
  |  subst_tm var_ty ((scons) ?ttm1 (scons_p ?p_ ?ttm0 var_tm)) ?ttm  =>  unify   (subst_tm var_ty ((scons) stm1 (scons_p p stm0 var_tm)) (subst_tm sigmaty ((scons) (var_tm (var_zero)) (scons_p p ((funcomp) ((funcomp) var_tm (shift)) (zero_p p)) ((funcomp) (ren_tm (id) ((funcomp) (shift) (shift_p p))) sigmatm))) stm)) (hexp)
  end
  |  subst_tm ?sigmaty (scons_p ?q ?stm1 (scons_p ?p ?stm0 ?sigmatm)) ?stm  =>  match   hexp  with
  |  subst_tm var_ty (scons_p ?q_ ?ttm1 (scons_p ?p_ ?ttm0 var_tm)) ?ttm  =>  unify   (subst_tm var_ty (scons_p q stm1 (scons_p p stm0 var_tm)) (subst_tm sigmaty (scons_p q ((funcomp) var_tm (zero_p q)) (scons_p p ((funcomp) ((funcomp) var_tm (shift_p q)) (zero_p p)) ((funcomp) (ren_tm (id) ((funcomp) (shift_p q) (shift_p p))) sigmatm))) stm)) (hexp)
  end
  |  ?s  =>  match   hexp  with
  ...
  |  lam4 ?s0  =>  match   hexp  with
  |  lam4 ?t0  =>  heuristics   (s0) (t0)
  end
  |  con5 ?s0  =>  match   hexp  with
  |  con5 ?t0  =>  heuristics   (s0) (t0)
  end
  |  lam5 ?p ?s0  =>  match   hexp  with
  |  lam5 ?p_ ?t0  =>  heuristics   (p) (p_); heuristics   (s0) (t0)
  end
  |  lam6 ?p ?s0  =>  match   hexp  with
  |  lam6 ?p_ ?t0  =>  heuristics   (p) (p_); heuristics   (s0) (t0)
  end
  |  lam7 ?p ?q ?s0  =>  match   hexp  with
  |  lam7 ?p_ ?q_ ?t0  =>  heuristics   (p) (p_); heuristics   (q) (q_); heuristics   (s0) (t0)
  end
  |  con6 ?s0 ?s1  =>  match   hexp  with
  |  con6 ?t0 ?t1  =>  heuristics   (s0) (t0); heuristics   (s1) (t1)
  end
  |  subst_tm ?sigma0 ?sigma1 ?s  =>  match   hexp  with
