...
Ltac  musigma gexp hexp :=
  ...
  |  lam ((fun x => x) ?s0) (subst_tm ((scons) (var_tm (var_zero)) ((funcomp) (ren_tm (shift)) ?sigma0)) ?s1)  =>  first [ unify   (subst_tm sigma0 (lam s0 s1)) (hexp)|  musigma   (subst_tm sigma0 (lam s0 s1)) (hexp) ]
  |  inl (subst_tm ?sigma0 ?s0)  =>  first [ unify   (subst_tm sigma0 (inl s0)) (hexp)|  musigma   (subst_tm sigma0 (inl s0)) (hexp) ]
  |  inr (subst_tm ?sigma0 ?s0)  =>  first [ unify   (subst_tm sigma0 (inr s0)) (hexp)|  musigma   (subst_tm sigma0 (inr s0)) (hexp) ]
  |  orelim (subst_tm ?sigma0 ?s0) (subst_tm ((scons) (var_tm (var_zero)) ((funcomp) (ren_tm (shift)) ?sigma0)) ?s1) (subst_tm ((scons) (var_tm (var_zero)) ((funcomp) (ren_tm (shift)) ?sigma0)) ?s2)  =>  first [ unify   (subst_tm sigma0 (orelim s0 s1 s2)) (hexp)|  musigma   (subst_tm sigma0 (orelim s0 s1 s2)) (hexp) ]
  |  app (ren_tm ?sigma0 ?s0) (ren_tm ?sigma0 ?s1)  =>  first [ unify   (ren_tm sigma0 (app s0 s1)) (hexp)|  musigma   (ren_tm sigma0 (app s0 s1)) (hexp) ]
  |  lam ((fun x => x) ?s0) (ren_tm ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s1)  =>  first [ unify   (ren_tm sigma0 (lam s0 s1)) (hexp)|  musigma   (ren_tm sigma0 (lam s0 s1)) (hexp) ]
  |  inl (ren_tm ?sigma0 ?s0)  =>  first [ unify   (ren_tm sigma0 (inl s0)) (hexp)|  musigma   (ren_tm sigma0 (inl s0)) (hexp) ]
  |  inr (ren_tm ?sigma0 ?s0)  =>  first [ unify   (ren_tm sigma0 (inr s0)) (hexp)|  musigma   (ren_tm sigma0 (inr s0)) (hexp) ]
  |  orelim (ren_tm ?sigma0 ?s0) (ren_tm ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s1) (ren_tm ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s2)  =>  first [ unify   (ren_tm sigma0 (orelim s0 s1 s2)) (hexp)|  musigma   (ren_tm sigma0 (orelim s0 s1 s2)) (hexp) ]
  ...
  |  inl ?t0  =>  musigma   (s0) (t0)
  end
  |  inr ?s0  =>  match   hexp  with
  |  inr ?t0  =>  musigma   (s0) (t0)
  end
  |  orelim ?s0 ?s1 ?s2  =>  match   hexp  with
  |  orelim ?t0 ?t1 ?t2  =>  musigma   (s0) (t0); musigma   (s1) (t1); musigma   (s2) (t2)
  end
