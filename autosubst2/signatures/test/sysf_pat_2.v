...
Ltac  musigma gexp hexp :=
  ...
  |  patvar (subst_ty ?sigma0 ?s0)  =>  first [ unify   (subst_pat sigma0 (patvar s0)) (hexp)|  musigma   (subst_pat sigma0 (patvar s0)) (hexp) ]
  |  patlist (list_map (prod_map (fun x => x) (subst_pat ?sigma0)) ?s0)  =>  first [ unify   (subst_pat sigma0 (patlist s0)) (hexp)|  musigma   (subst_pat sigma0 (patlist s0)) (hexp) ]
  |  patvar (ren_ty ?sigma0 ?s0)  =>  first [ unify   (ren_pat sigma0 (patvar s0)) (hexp)|  musigma   (ren_pat sigma0 (patvar s0)) (hexp) ]
  |  patlist (list_map (prod_map (fun x => x) (ren_pat ?sigma0)) ?s0)  =>  first [ unify   (ren_pat sigma0 (patlist s0)) (hexp)|  musigma   (ren_pat sigma0 (patlist s0)) (hexp) ]
  ...
  |  letpat ?p (subst_pat ?sigma0 ?s0) (subst_tm ?sigma1 ?sigma0 ?s1) (subst_tm (scons_p ?p ((funcomp) var_tm (zero_p ?p)) ((funcomp) (ren_tm (id) (shift_p ?p)) ?sigma1)) ?sigma0 ?s2)  =>  first [ unify   (subst_tm sigma0 sigma1 (letpat p s0 s1 s2)) (hexp)|  musigma   (subst_tm sigma0 sigma1 (letpat p s0 s1 s2)) (hexp) ]
  ...
  |  letpat ?p (ren_pat ?sigma0 ?s0) (ren_tm ?sigma1 ?sigma0 ?s1) (ren_tm (scons_p ?p (zero_p ?p) ((funcomp) (shift_p ?p) ?sigma1)) ?sigma0 ?s2)  =>  first [ unify   (ren_tm sigma0 sigma1 (letpat p s0 s1 s2)) (hexp)|  musigma   (ren_tm sigma0 sigma1 (letpat p s0 s1 s2)) (hexp) ]
  ...
  |  ren_pat ?theta0 ?t  =>  first [ unify   (ren_pat tau0 (ren_pat sigma0 s)) (hexp)|  musigma   (ren_pat tau0 (ren_pat sigma0 s)) (hexp) ]
  end
  |  subst_pat ((funcomp) ?tau0 ?sigma0) ?s  =>  match   hexp  with
  |  subst_pat ?theta0 ?t  =>  first [ unify   (subst_pat tau0 (ren_pat sigma0 s)) (hexp)|  musigma   (subst_pat tau0 (ren_pat sigma0 s)) (hexp) ]
  end
  |  subst_pat ((funcomp) (ren_ty ?tau0) ?sigma0) ?s  =>  match   hexp  with
  |  ren_pat ?theta0 ?t  =>  first [ unify   (ren_pat tau0 (subst_pat sigma0 s)) (hexp)|  musigma   (ren_pat tau0 (subst_pat sigma0 s)) (hexp) ]
  end
  |  subst_pat ((funcomp) (subst_ty ?tau0) ?sigma0) ?s  =>  match   hexp  with
  |  subst_pat ?theta0 ?t  =>  first [ unify   (subst_pat tau0 (subst_pat sigma0 s)) (hexp)|  musigma   (subst_pat tau0 (subst_pat sigma0 s)) (hexp) ]
  end
  ...
  |  (funcomp) (ren_pat ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (ren_pat tau0) ((funcomp) (ren_pat sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (ren_pat tau0) ((funcomp) (ren_pat sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_pat ((funcomp) ?tau0 ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_pat ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (subst_pat tau0) ((funcomp) (ren_pat sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (subst_pat tau0) ((funcomp) (ren_pat sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_pat ((funcomp) (ren_ty ?tau0) ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_pat ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (ren_pat tau0) ((funcomp) (subst_pat sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (ren_pat tau0) ((funcomp) (subst_pat sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_pat ((funcomp) (subst_ty ?tau0) ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_pat ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (subst_pat tau0) ((funcomp) (subst_pat sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (subst_pat tau0) ((funcomp) (subst_pat sigma0) sigmas)) (hexp) ]
  end
  ...
  |  (funcomp) (ren_pat ?tau0) ?thetah  =>  first [ unify   ((funcomp) (ren_pat sigma0) ((scons) s thetag)) (hexp)|  musigma   ((funcomp) (ren_pat sigma0) ((scons) s thetag)) (hexp) ]
  end
  |  (scons) (subst_pat ?sigma0 ?s) ((funcomp) (subst_pat ?sigma0) ?thetag)  =>  match   hexp  with
  |  (funcomp) (subst_pat ?tau0) ?thetah  =>  first [ unify   ((funcomp) (subst_pat sigma0) ((scons) s thetag)) (hexp)|  musigma   ((funcomp) (subst_pat sigma0) ((scons) s thetag)) (hexp) ]
  end
  ...
  |  patvar ?t0  =>  musigma   (s0) (t0)
  end
  |  patlist ?s0  =>  match   hexp  with
  |  patlist ?t0  =>  musigma   (s0) (t0)
  end
  |  subst_pat ?sigma0 ?s  =>  match   hexp  with
  |  subst_pat ?tau0 ?t  =>  musigma   (s) (t); musigma   (sigma0) (tau0)
  end
  |  ren_pat ?sigma0 ?s  =>  match   hexp  with
  |  ren_pat ?tau0 ?t  =>  musigma   (s) (t); musigma   (sigma0) (tau0)
  end
  |  (funcomp) (subst_pat ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_pat ?tau0) ?tau  =>  musigma   (sigma) (tau); musigma   (sigma0) (tau0)
  end
  |  (funcomp) (ren_pat ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_pat ?tau0) ?tau  =>  musigma   (sigma) (tau); musigma   (sigma0) (tau0)
  end
  ...
  |  letpat ?p_ ?t0 ?t1 ?t2  =>  musigma   (p) (p_); musigma   (s0) (t0); musigma   (s1) (t1); musigma   (s2) (t2)
  end
...
Ltac  heuristics gexp hexp :=
  ...
  assert ((funcomp) (subst_pat ((funcomp) var_ty sigma0)) sigma = (funcomp) (ren_pat sigma0) sigma) as eq by (renamify; reflexivity); rewrite   (eq); unify   ((funcomp) (ren_pat sigma0) sigma) (hexp); clear eq
  end
  |  subst_pat ((funcomp) var_ty ?sigma0) ?s  =>  match   hexp  with
  |  ren_pat ?tau0 ?t  =>  let eq := fresh "eq" in
  assert (subst_pat ((funcomp) var_ty sigma0) s = ren_pat sigma0 s) as eq by (renamify; reflexivity); rewrite   (eq); unify   (ren_pat sigma0 s) (hexp); clear eq
  end
  ...
  assert ((funcomp) (ren_pat sigma0) sigma = (funcomp) (subst_pat ((funcomp) var_ty sigma0)) sigma) as eq by (substify; reflexivity); rewrite   (eq); unify   ((funcomp) (subst_pat ((funcomp) var_ty sigma0)) sigma) (hexp); clear eq
  end
  |  ren_pat ?sigma0 ?s  =>  match   hexp  with
  |  subst_pat ?tau0 ?t  =>  let eq := fresh "eq" in
  assert (ren_pat sigma0 s = subst_pat ((funcomp) var_ty sigma0) s) as eq by (substify; reflexivity); rewrite   (eq); unify   (subst_pat ((funcomp) var_ty sigma0) s) (hexp); clear eq
  end
  |  (funcomp) (ren_tm ?sigma0 ?sigma1) ?sigma  =>  match   hexp  with
