...
Fixpoint ren_value { mvalue : nat } { nvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (nvalue)) (s : value (mvalue)) : value (nvalue) :=
    match s return value (nvalue) with
 ...
 with ren_comp { mvalue : nat } { nvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (nvalue)) (s : comp (mvalue)) : comp (nvalue) :=
    match s return comp (nvalue) with
    | cu (_)  => cu (nvalue)
...
Fixpoint idSubst_value { mvalue : nat } (sigmavalue : (fin) (mvalue) -> value (mvalue)) (Eqvalue : forall x, sigmavalue x = (var_value (mvalue)) x) (s : value (mvalue)) : subst_value sigmavalue s = s :=
    match s return subst_value sigmavalue s = s with
 ...
 with idSubst_comp { mvalue : nat } (sigmavalue : (fin) (mvalue) -> value (mvalue)) (Eqvalue : forall x, sigmavalue x = (var_value (mvalue)) x) (s : comp (mvalue)) : subst_comp sigmavalue s = s :=
    match s return subst_comp sigmavalue s = s with
    | cu (_)  => congr_cu 
...
Fixpoint extRen_value { mvalue : nat } { nvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (nvalue)) (zetavalue : (fin) (mvalue) -> (fin) (nvalue)) (Eqvalue : forall x, xivalue x = zetavalue x) (s : value (mvalue)) : ren_value xivalue s = ren_value zetavalue s :=
    match s return ren_value xivalue s = ren_value zetavalue s with
 ...
 with extRen_comp { mvalue : nat } { nvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (nvalue)) (zetavalue : (fin) (mvalue) -> (fin) (nvalue)) (Eqvalue : forall x, xivalue x = zetavalue x) (s : comp (mvalue)) : ren_comp xivalue s = ren_comp zetavalue s :=
    match s return ren_comp xivalue s = ren_comp zetavalue s with
    | cu (_)  => congr_cu 
...
Fixpoint ext_value { mvalue : nat } { nvalue : nat } (sigmavalue : (fin) (mvalue) -> value (nvalue)) (tauvalue : (fin) (mvalue) -> value (nvalue)) (Eqvalue : forall x, sigmavalue x = tauvalue x) (s : value (mvalue)) : subst_value sigmavalue s = subst_value tauvalue s :=
    match s return subst_value sigmavalue s = subst_value tauvalue s with
    | var_value (_) s => Eqvalue s
    | u (_)  => congr_u 
 ...
 with ext_comp { mvalue : nat } { nvalue : nat } (sigmavalue : (fin) (mvalue) -> value (nvalue)) (tauvalue : (fin) (mvalue) -> value (nvalue)) (Eqvalue : forall x, sigmavalue x = tauvalue x) (s : comp (mvalue)) : subst_comp sigmavalue s = subst_comp tauvalue s :=
    match s return subst_comp sigmavalue s = subst_comp tauvalue s with
    | cu (_)  => congr_cu 
...
Fixpoint compRenRen_value { kvalue : nat } { lvalue : nat } { mvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (kvalue)) (zetavalue : (fin) (kvalue) -> (fin) (lvalue)) (rhovalue : (fin) (mvalue) -> (fin) (lvalue)) (Eqvalue : forall x, ((funcomp) zetavalue xivalue) x = rhovalue x) (s : value (mvalue)) : ren_value zetavalue (ren_value xivalue s) = ren_value rhovalue s :=
    match s return ren_value zetavalue (ren_value xivalue s) = ren_value rhovalue s with
 ...
 with compRenRen_comp { kvalue : nat } { lvalue : nat } { mvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (kvalue)) (zetavalue : (fin) (kvalue) -> (fin) (lvalue)) (rhovalue : (fin) (mvalue) -> (fin) (lvalue)) (Eqvalue : forall x, ((funcomp) zetavalue xivalue) x = rhovalue x) (s : comp (mvalue)) : ren_comp zetavalue (ren_comp xivalue s) = ren_comp rhovalue s :=
    match s return ren_comp zetavalue (ren_comp xivalue s) = ren_comp rhovalue s with
    | cu (_)  => congr_cu 
...
Fixpoint compRenSubst_value { kvalue : nat } { lvalue : nat } { mvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (kvalue)) (tauvalue : (fin) (kvalue) -> value (lvalue)) (thetavalue : (fin) (mvalue) -> value (lvalue)) (Eqvalue : forall x, ((funcomp) tauvalue xivalue) x = thetavalue x) (s : value (mvalue)) : subst_value tauvalue (ren_value xivalue s) = subst_value thetavalue s :=
    match s return subst_value tauvalue (ren_value xivalue s) = subst_value thetavalue s with
    | var_value (_) s => Eqvalue s
    | u (_)  => congr_u 
 ...
 with compRenSubst_comp { kvalue : nat } { lvalue : nat } { mvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (kvalue)) (tauvalue : (fin) (kvalue) -> value (lvalue)) (thetavalue : (fin) (mvalue) -> value (lvalue)) (Eqvalue : forall x, ((funcomp) tauvalue xivalue) x = thetavalue x) (s : comp (mvalue)) : subst_comp tauvalue (ren_comp xivalue s) = subst_comp thetavalue s :=
    match s return subst_comp tauvalue (ren_comp xivalue s) = subst_comp thetavalue s with
    | cu (_)  => congr_cu 
...
Fixpoint compSubstRen_value { kvalue : nat } { lvalue : nat } { mvalue : nat } (sigmavalue : (fin) (mvalue) -> value (kvalue)) (zetavalue : (fin) (kvalue) -> (fin) (lvalue)) (thetavalue : (fin) (mvalue) -> value (lvalue)) (Eqvalue : forall x, ((funcomp) (ren_value zetavalue) sigmavalue) x = thetavalue x) (s : value (mvalue)) : ren_value zetavalue (subst_value sigmavalue s) = subst_value thetavalue s :=
    match s return ren_value zetavalue (subst_value sigmavalue s) = subst_value thetavalue s with
    | var_value (_) s => Eqvalue s
    | u (_)  => congr_u 
 ...
 with compSubstRen_comp { kvalue : nat } { lvalue : nat } { mvalue : nat } (sigmavalue : (fin) (mvalue) -> value (kvalue)) (zetavalue : (fin) (kvalue) -> (fin) (lvalue)) (thetavalue : (fin) (mvalue) -> value (lvalue)) (Eqvalue : forall x, ((funcomp) (ren_value zetavalue) sigmavalue) x = thetavalue x) (s : comp (mvalue)) : ren_comp zetavalue (subst_comp sigmavalue s) = subst_comp thetavalue s :=
    match s return ren_comp zetavalue (subst_comp sigmavalue s) = subst_comp thetavalue s with
    | cu (_)  => congr_cu 
...
Fixpoint compSubstSubst_value { kvalue : nat } { lvalue : nat } { mvalue : nat } (sigmavalue : (fin) (mvalue) -> value (kvalue)) (tauvalue : (fin) (kvalue) -> value (lvalue)) (thetavalue : (fin) (mvalue) -> value (lvalue)) (Eqvalue : forall x, ((funcomp) (subst_value tauvalue) sigmavalue) x = thetavalue x) (s : value (mvalue)) : subst_value tauvalue (subst_value sigmavalue s) = subst_value thetavalue s :=
    match s return subst_value tauvalue (subst_value sigmavalue s) = subst_value thetavalue s with
    | var_value (_) s => Eqvalue s
    | u (_)  => congr_u 
 ...
 with compSubstSubst_comp { kvalue : nat } { lvalue : nat } { mvalue : nat } (sigmavalue : (fin) (mvalue) -> value (kvalue)) (tauvalue : (fin) (kvalue) -> value (lvalue)) (thetavalue : (fin) (mvalue) -> value (lvalue)) (Eqvalue : forall x, ((funcomp) (subst_value tauvalue) sigmavalue) x = thetavalue x) (s : comp (mvalue)) : subst_comp tauvalue (subst_comp sigmavalue s) = subst_comp thetavalue s :=
    match s return subst_comp tauvalue (subst_comp sigmavalue s) = subst_comp thetavalue s with
    | cu (_)  => congr_cu 
...
Fixpoint rinst_inst_value { mvalue : nat } { nvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (nvalue)) (sigmavalue : (fin) (mvalue) -> value (nvalue)) (Eqvalue : forall x, ((funcomp) (var_value (nvalue)) xivalue) x = sigmavalue x) (s : value (mvalue)) : ren_value xivalue s = subst_value sigmavalue s :=
    match s return ren_value xivalue s = subst_value sigmavalue s with
    | var_value (_) s => Eqvalue s
    | u (_)  => congr_u 
 ...
 with rinst_inst_comp { mvalue : nat } { nvalue : nat } (xivalue : (fin) (mvalue) -> (fin) (nvalue)) (sigmavalue : (fin) (mvalue) -> value (nvalue)) (Eqvalue : forall x, ((funcomp) (var_value (nvalue)) xivalue) x = sigmavalue x) (s : comp (mvalue)) : ren_comp xivalue s = subst_comp sigmavalue s :=
    match s return ren_comp xivalue s = subst_comp sigmavalue s with
    | cu (_)  => congr_cu 
...
Ltac  musigma gexp hexp :=
  match   gexp  with
  |  ?s  =>  unify   (gexp) (hexp)
  |  pair (subst_value ?sigma0 ?s0) (subst_value ?sigma0 ?s1)  =>  first [ unify   (subst_value sigma0 (pair s0 s1)) (hexp)|  musigma   (subst_value sigma0 (pair s0 s1)) (hexp) ]
  |  inj ((fun x => x) ?s0) (subst_value ?sigma0 ?s1)  =>  first [ unify   (subst_value sigma0 (inj s0 s1)) (hexp)|  musigma   (subst_value sigma0 (inj s0 s1)) (hexp) ]
  |  thunk (subst_comp ?sigma0 ?s0)  =>  first [ unify   (subst_value sigma0 (thunk s0)) (hexp)|  musigma   (subst_value sigma0 (thunk s0)) (hexp) ]
  |  pair (ren_value ?sigma0 ?s0) (ren_value ?sigma0 ?s1)  =>  first [ unify   (ren_value sigma0 (pair s0 s1)) (hexp)|  musigma   (ren_value sigma0 (pair s0 s1)) (hexp) ]
  |  inj ((fun x => x) ?s0) (ren_value ?sigma0 ?s1)  =>  first [ unify   (ren_value sigma0 (inj s0 s1)) (hexp)|  musigma   (ren_value sigma0 (inj s0 s1)) (hexp) ]
  |  thunk (ren_comp ?sigma0 ?s0)  =>  first [ unify   (ren_value sigma0 (thunk s0)) (hexp)|  musigma   (ren_value sigma0 (thunk s0)) (hexp) ]
  |  force (subst_value ?sigma0 ?s0)  =>  first [ unify   (subst_comp sigma0 (force s0)) (hexp)|  musigma   (subst_comp sigma0 (force s0)) (hexp) ]
  |  lambda (subst_comp ((scons) (var_value (var_zero)) ((funcomp) (ren_value (shift)) ?sigma0)) ?s0)  =>  first [ unify   (subst_comp sigma0 (lambda s0)) (hexp)|  musigma   (subst_comp sigma0 (lambda s0)) (hexp) ]
  |  app (subst_comp ?sigma0 ?s0) (subst_value ?sigma0 ?s1)  =>  first [ unify   (subst_comp sigma0 (app s0 s1)) (hexp)|  musigma   (subst_comp sigma0 (app s0 s1)) (hexp) ]
  |  tuple (subst_comp ?sigma0 ?s0) (subst_comp ?sigma0 ?s1)  =>  first [ unify   (subst_comp sigma0 (tuple s0 s1)) (hexp)|  musigma   (subst_comp sigma0 (tuple s0 s1)) (hexp) ]
  |  ret (subst_value ?sigma0 ?s0)  =>  first [ unify   (subst_comp sigma0 (ret s0)) (hexp)|  musigma   (subst_comp sigma0 (ret s0)) (hexp) ]
  |  letin (subst_comp ?sigma0 ?s0) (subst_comp ((scons) (var_value (var_zero)) ((funcomp) (ren_value (shift)) ?sigma0)) ?s1)  =>  first [ unify   (subst_comp sigma0 (letin s0 s1)) (hexp)|  musigma   (subst_comp sigma0 (letin s0 s1)) (hexp) ]
  |  proj ((fun x => x) ?s0) (subst_comp ?sigma0 ?s1)  =>  first [ unify   (subst_comp sigma0 (proj s0 s1)) (hexp)|  musigma   (subst_comp sigma0 (proj s0 s1)) (hexp) ]
  |  caseZ (subst_value ?sigma0 ?s0)  =>  first [ unify   (subst_comp sigma0 (caseZ s0)) (hexp)|  musigma   (subst_comp sigma0 (caseZ s0)) (hexp) ]
  |  caseS (subst_value ?sigma0 ?s0) (subst_comp ((scons) (var_value (var_zero)) ((funcomp) (ren_value (shift)) ?sigma0)) ?s1) (subst_comp ((scons) (var_value (var_zero)) ((funcomp) (ren_value (shift)) ?sigma0)) ?s2)  =>  first [ unify   (subst_comp sigma0 (caseS s0 s1 s2)) (hexp)|  musigma   (subst_comp sigma0 (caseS s0 s1 s2)) (hexp) ]
  |  caseP (subst_value ?sigma0 ?s0) (subst_comp ((scons) (var_value (var_zero)) ((scons) (var_value ((shift) (var_zero))) ((funcomp) (ren_value ((funcomp) (shift) (shift))) ?sigma0))) ?s1)  =>  first [ unify   (subst_comp sigma0 (caseP s0 s1)) (hexp)|  musigma   (subst_comp sigma0 (caseP s0 s1)) (hexp) ]
  |  force (ren_value ?sigma0 ?s0)  =>  first [ unify   (ren_comp sigma0 (force s0)) (hexp)|  musigma   (ren_comp sigma0 (force s0)) (hexp) ]
  |  lambda (ren_comp ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s0)  =>  first [ unify   (ren_comp sigma0 (lambda s0)) (hexp)|  musigma   (ren_comp sigma0 (lambda s0)) (hexp) ]
  |  app (ren_comp ?sigma0 ?s0) (ren_value ?sigma0 ?s1)  =>  first [ unify   (ren_comp sigma0 (app s0 s1)) (hexp)|  musigma   (ren_comp sigma0 (app s0 s1)) (hexp) ]
  |  tuple (ren_comp ?sigma0 ?s0) (ren_comp ?sigma0 ?s1)  =>  first [ unify   (ren_comp sigma0 (tuple s0 s1)) (hexp)|  musigma   (ren_comp sigma0 (tuple s0 s1)) (hexp) ]
  |  ret (ren_value ?sigma0 ?s0)  =>  first [ unify   (ren_comp sigma0 (ret s0)) (hexp)|  musigma   (ren_comp sigma0 (ret s0)) (hexp) ]
  |  letin (ren_comp ?sigma0 ?s0) (ren_comp ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s1)  =>  first [ unify   (ren_comp sigma0 (letin s0 s1)) (hexp)|  musigma   (ren_comp sigma0 (letin s0 s1)) (hexp) ]
  |  proj ((fun x => x) ?s0) (ren_comp ?sigma0 ?s1)  =>  first [ unify   (ren_comp sigma0 (proj s0 s1)) (hexp)|  musigma   (ren_comp sigma0 (proj s0 s1)) (hexp) ]
  |  caseZ (ren_value ?sigma0 ?s0)  =>  first [ unify   (ren_comp sigma0 (caseZ s0)) (hexp)|  musigma   (ren_comp sigma0 (caseZ s0)) (hexp) ]
  |  caseS (ren_value ?sigma0 ?s0) (ren_comp ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s1) (ren_comp ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s2)  =>  first [ unify   (ren_comp sigma0 (caseS s0 s1 s2)) (hexp)|  musigma   (ren_comp sigma0 (caseS s0 s1 s2)) (hexp) ]
  |  caseP (ren_value ?sigma0 ?s0) (ren_comp ((scons) (var_zero) ((scons) ((shift) (var_zero)) ((funcomp) ((funcomp) (shift) (shift)) ?sigma0))) ?s1)  =>  first [ unify   (ren_comp sigma0 (caseP s0 s1)) (hexp)|  musigma   (ren_comp sigma0 (caseP s0 s1)) (hexp) ]
  |  ren_value ((funcomp) ?tau0 ?sigma0) ?s  =>  match   hexp  with
  |  ren_value ?theta0 ?t  =>  first [ unify   (ren_value tau0 (ren_value sigma0 s)) (hexp)|  musigma   (ren_value tau0 (ren_value sigma0 s)) (hexp) ]
  end
  |  subst_value ((funcomp) ?tau0 ?sigma0) ?s  =>  match   hexp  with
  |  subst_value ?theta0 ?t  =>  first [ unify   (subst_value tau0 (ren_value sigma0 s)) (hexp)|  musigma   (subst_value tau0 (ren_value sigma0 s)) (hexp) ]
  end
  |  subst_value ((funcomp) (ren_value ?tau0) ?sigma0) ?s  =>  match   hexp  with
  |  ren_value ?theta0 ?t  =>  first [ unify   (ren_value tau0 (subst_value sigma0 s)) (hexp)|  musigma   (ren_value tau0 (subst_value sigma0 s)) (hexp) ]
  end
  |  subst_value ((funcomp) (subst_value ?tau0) ?sigma0) ?s  =>  match   hexp  with
  |  subst_value ?theta0 ?t  =>  first [ unify   (subst_value tau0 (subst_value sigma0 s)) (hexp)|  musigma   (subst_value tau0 (subst_value sigma0 s)) (hexp) ]
  end
  |  ren_comp ((funcomp) ?tau0 ?sigma0) ?s  =>  match   hexp  with
  |  ren_comp ?theta0 ?t  =>  first [ unify   (ren_comp tau0 (ren_comp sigma0 s)) (hexp)|  musigma   (ren_comp tau0 (ren_comp sigma0 s)) (hexp) ]
  end
  |  subst_comp ((funcomp) ?tau0 ?sigma0) ?s  =>  match   hexp  with
  |  subst_comp ?theta0 ?t  =>  first [ unify   (subst_comp tau0 (ren_comp sigma0 s)) (hexp)|  musigma   (subst_comp tau0 (ren_comp sigma0 s)) (hexp) ]
  end
  |  subst_comp ((funcomp) (ren_value ?tau0) ?sigma0) ?s  =>  match   hexp  with
  |  ren_comp ?theta0 ?t  =>  first [ unify   (ren_comp tau0 (subst_comp sigma0 s)) (hexp)|  musigma   (ren_comp tau0 (subst_comp sigma0 s)) (hexp) ]
  end
  |  subst_comp ((funcomp) (subst_value ?tau0) ?sigma0) ?s  =>  match   hexp  with
  |  subst_comp ?theta0 ?t  =>  first [ unify   (subst_comp tau0 (subst_comp sigma0 s)) (hexp)|  musigma   (subst_comp tau0 (subst_comp sigma0 s)) (hexp) ]
  end
  |  (funcomp) (ren_value ((funcomp) ?tau0 ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_value ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (ren_value tau0) ((funcomp) (ren_value sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (ren_value tau0) ((funcomp) (ren_value sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_value ((funcomp) ?tau0 ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_value ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (subst_value tau0) ((funcomp) (ren_value sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (subst_value tau0) ((funcomp) (ren_value sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_value ((funcomp) (ren_value ?tau0) ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_value ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (ren_value tau0) ((funcomp) (subst_value sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (ren_value tau0) ((funcomp) (subst_value sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_value ((funcomp) (subst_value ?tau0) ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_value ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (subst_value tau0) ((funcomp) (subst_value sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (subst_value tau0) ((funcomp) (subst_value sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (ren_comp ((funcomp) ?tau0 ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_comp ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (ren_comp tau0) ((funcomp) (ren_comp sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (ren_comp tau0) ((funcomp) (ren_comp sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_comp ((funcomp) ?tau0 ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_comp ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (subst_comp tau0) ((funcomp) (ren_comp sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (subst_comp tau0) ((funcomp) (ren_comp sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_comp ((funcomp) (ren_value ?tau0) ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_comp ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (ren_comp tau0) ((funcomp) (subst_comp sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (ren_comp tau0) ((funcomp) (subst_comp sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_comp ((funcomp) (subst_value ?tau0) ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_comp ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (subst_comp tau0) ((funcomp) (subst_comp sigma0) sigmas)) (hexp)|  musigma   ((funcomp) (subst_comp tau0) ((funcomp) (subst_comp sigma0) sigmas)) (hexp) ]
  end
  |  (scons) (ren_value ?sigma0 ?s) ((funcomp) (ren_value ?sigma0) ?thetag)  =>  match   hexp  with
  |  (funcomp) (ren_value ?tau0) ?thetah  =>  first [ unify   ((funcomp) (ren_value sigma0) ((scons) s thetag)) (hexp)|  musigma   ((funcomp) (ren_value sigma0) ((scons) s thetag)) (hexp) ]
  end
  |  (scons) (subst_value ?sigma0 ?s) ((funcomp) (subst_value ?sigma0) ?thetag)  =>  match   hexp  with
  |  (funcomp) (subst_value ?tau0) ?thetah  =>  first [ unify   ((funcomp) (subst_value sigma0) ((scons) s thetag)) (hexp)|  musigma   ((funcomp) (subst_value sigma0) ((scons) s thetag)) (hexp) ]
  end
  |  (scons) (ren_comp ?sigma0 ?s) ((funcomp) (ren_comp ?sigma0) ?thetag)  =>  match   hexp  with
  |  (funcomp) (ren_comp ?tau0) ?thetah  =>  first [ unify   ((funcomp) (ren_comp sigma0) ((scons) s thetag)) (hexp)|  musigma   ((funcomp) (ren_comp sigma0) ((scons) s thetag)) (hexp) ]
  end
  |  (scons) (subst_comp ?sigma0 ?s) ((funcomp) (subst_comp ?sigma0) ?thetag)  =>  match   hexp  with
  |  (funcomp) (subst_comp ?tau0) ?thetah  =>  first [ unify   ((funcomp) (subst_comp sigma0) ((scons) s thetag)) (hexp)|  musigma   ((funcomp) (subst_comp sigma0) ((scons) s thetag)) (hexp) ]
  end
  |  pair ?s0 ?s1  =>  match   hexp  with
  |  pair ?t0 ?t1  =>  musigma   (s0) (t0); musigma   (s1) (t1)
  end
  |  inj ?s0 ?s1  =>  match   hexp  with
  |  inj ?t0 ?t1  =>  musigma   (s0) (t0); musigma   (s1) (t1)
  end
  |  thunk ?s0  =>  match   hexp  with
  |  thunk ?t0  =>  musigma   (s0) (t0)
  end
  |  subst_value ?sigma0 ?s  =>  match   hexp  with
  |  subst_value ?tau0 ?t  =>  musigma   (s) (t); musigma   (sigma0) (tau0)
  end
  |  ren_value ?sigma0 ?s  =>  match   hexp  with
  |  ren_value ?tau0 ?t  =>  musigma   (s) (t); musigma   (sigma0) (tau0)
  end
  |  (funcomp) (subst_value ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_value ?tau0) ?tau  =>  musigma   (sigma) (tau); musigma   (sigma0) (tau0)
  end
  |  (funcomp) (ren_value ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_value ?tau0) ?tau  =>  musigma   (sigma) (tau); musigma   (sigma0) (tau0)
  end
  |  force ?s0  =>  match   hexp  with
  |  force ?t0  =>  musigma   (s0) (t0)
  end
  |  lambda ?s0  =>  match   hexp  with
  |  lambda ?t0  =>  musigma   (s0) (t0)
  end
  |  app ?s0 ?s1  =>  match   hexp  with
  |  app ?t0 ?t1  =>  musigma   (s0) (t0); musigma   (s1) (t1)
  end
  |  tuple ?s0 ?s1  =>  match   hexp  with
  |  tuple ?t0 ?t1  =>  musigma   (s0) (t0); musigma   (s1) (t1)
  end
  |  ret ?s0  =>  match   hexp  with
  |  ret ?t0  =>  musigma   (s0) (t0)
  end
  |  letin ?s0 ?s1  =>  match   hexp  with
  |  letin ?t0 ?t1  =>  musigma   (s0) (t0); musigma   (s1) (t1)
  end
  |  proj ?s0 ?s1  =>  match   hexp  with
  |  proj ?t0 ?t1  =>  musigma   (s0) (t0); musigma   (s1) (t1)
  end
  |  caseZ ?s0  =>  match   hexp  with
  |  caseZ ?t0  =>  musigma   (s0) (t0)
  end
  |  caseS ?s0 ?s1 ?s2  =>  match   hexp  with
  |  caseS ?t0 ?t1 ?t2  =>  musigma   (s0) (t0); musigma   (s1) (t1); musigma   (s2) (t2)
  end
  |  caseP ?s0 ?s1  =>  match   hexp  with
  |  caseP ?t0 ?t1  =>  musigma   (s0) (t0); musigma   (s1) (t1)
  end
  |  subst_comp ?sigma0 ?s  =>  match   hexp  with
  |  subst_comp ?tau0 ?t  =>  musigma   (s) (t); musigma   (sigma0) (tau0)
  end
  |  ren_comp ?sigma0 ?s  =>  match   hexp  with
  |  ren_comp ?tau0 ?t  =>  musigma   (s) (t); musigma   (sigma0) (tau0)
  end
  |  (funcomp) (subst_comp ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_comp ?tau0) ?tau  =>  musigma   (sigma) (tau); musigma   (sigma0) (tau0)
  end
  |  (funcomp) (ren_comp ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_comp ?tau0) ?tau  =>  musigma   (sigma) (tau); musigma   (sigma0) (tau0)
  end
  end.
...
Ltac  heuristics gexp hexp :=
  ...
  assert ((funcomp) (subst_value ((funcomp) var_value sigma0)) sigma = (funcomp) (ren_value sigma0) sigma) as eq by (renamify; reflexivity); rewrite   (eq); unify   ((funcomp) (ren_value sigma0) sigma) (hexp); clear eq
  end
  |  subst_value ((funcomp) var_value ?sigma0) ?s  =>  match   hexp  with
  |  ren_value ?tau0 ?t  =>  let eq := fresh "eq" in
  assert (subst_value ((funcomp) var_value sigma0) s = ren_value sigma0 s) as eq by (renamify; reflexivity); rewrite   (eq); unify   (ren_value sigma0 s) (hexp); clear eq
  end
  |  (funcomp) (subst_comp ((funcomp) var_value ?sigma0)) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_comp ?tau0) ?tau  =>  let eq := fresh "eq" in
  assert ((funcomp) (subst_comp ((funcomp) var_value sigma0)) sigma = (funcomp) (ren_comp sigma0) sigma) as eq by (renamify; reflexivity); rewrite   (eq); unify   ((funcomp) (ren_comp sigma0) sigma) (hexp); clear eq
  end
  |  subst_comp ((funcomp) var_value ?sigma0) ?s  =>  match   hexp  with
  |  ren_comp ?tau0 ?t  =>  let eq := fresh "eq" in
  assert (subst_comp ((funcomp) var_value sigma0) s = ren_comp sigma0 s) as eq by (renamify; reflexivity); rewrite   (eq); unify   (ren_comp sigma0 s) (hexp); clear eq
  end
  |  (funcomp) (ren_value ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_value ?tau0) ?tau  =>  let eq := fresh "eq" in
  assert ((funcomp) (ren_value sigma0) sigma = (funcomp) (subst_value ((funcomp) var_value sigma0)) sigma) as eq by (substify; reflexivity); rewrite   (eq); unify   ((funcomp) (subst_value ((funcomp) var_value sigma0)) sigma) (hexp); clear eq
  end
  |  ren_value ?sigma0 ?s  =>  match   hexp  with
  |  subst_value ?tau0 ?t  =>  let eq := fresh "eq" in
  assert (ren_value sigma0 s = subst_value ((funcomp) var_value sigma0) s) as eq by (substify; reflexivity); rewrite   (eq); unify   (subst_value ((funcomp) var_value sigma0) s) (hexp); clear eq
  end
  |  (funcomp) (ren_comp ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_comp ?tau0) ?tau  =>  let eq := fresh "eq" in
  assert ((funcomp) (ren_comp sigma0) sigma = (funcomp) (subst_comp ((funcomp) var_value sigma0)) sigma) as eq by (substify; reflexivity); rewrite   (eq); unify   ((funcomp) (subst_comp ((funcomp) var_value sigma0)) sigma) (hexp); clear eq
  end
  |  ren_comp ?sigma0 ?s  =>  match   hexp  with
  |  subst_comp ?tau0 ?t  =>  let eq := fresh "eq" in
  assert (ren_comp sigma0 s = subst_comp ((funcomp) var_value sigma0) s) as eq by (substify; reflexivity); rewrite   (eq); unify   (subst_comp ((funcomp) var_value sigma0) s) (hexp); clear eq
  end
  |  ?s  =>  musigma   (gexp) (hexp)
