...
Lemma congr_Plus  { s0 : ty   } { s1 : ty   } { t0 : ty   } { t1 : ty   } (H1 : s0 = t0) (H2 : s1 = t1) : Plus s0 s1 = Plus t0 t1 .
Proof. congruence. Qed.
...
Lemma congr_orelim { mtm : nat } { s0 : tm  (mtm) } { s1 : tm  ((S) mtm) } { s2 : tm  ((S) mtm) } { t0 : tm  (mtm) } { t1 : tm  ((S) mtm) } { t2 : tm  ((S) mtm) } (H1 : s0 = t0) (H2 : s1 = t1) (H3 : s2 = t2) : orelim (mtm) s0 s1 s2 = orelim (mtm) t0 t1 t2 .
Proof. congruence. Qed.
...
Fixpoint compSubstRen_tm { ktm : nat } { ltm : nat } { mtm : nat } (sigmatm : (fin) (mtm) -> tm (ktm)) (zetatm : (fin) (ktm) -> (fin) (ltm)) (thetatm : (fin) (mtm) -> tm (ltm)) (Eqtm : forall x, ((funcomp) (ren_tm zetatm) sigmatm) x = thetatm x) (s : tm (mtm)) : ren_tm zetatm (subst_tm sigmatm s) = subst_tm thetatm s :=
    ...
    | orelim (_) s0 s1 s2 => congr_orelim ((compSubstRen_tm sigmatm zetatm thetatm Eqtm) s0) ((compSubstRen_tm (up_tm_tm sigmatm) (upRen_tm_tm zetatm) (up_tm_tm thetatm) (up_subst_ren_tm_tm (_) (_) (_) Eqtm)) s1) ((compSubstRen_tm (up_tm_tm sigmatm) (upRen_tm_tm zetatm) (up_tm_tm thetatm) (up_subst_ren_tm_tm (_) (_) (_) Eqtm)) s2)
    end.
...
Ltac  sigma_min gexp hexp :=
  ...
  |  lam ?t0 ?t1  =>  sigma_min   (s0) (t0); sigma_min   (s1) (t1)
  end
  |  inl ?s0  =>  match   hexp  with
  |  inl ?t0  =>  sigma_min   (s0) (t0)
  end
  |  inr ?s0  =>  match   hexp  with
  |  inr ?t0  =>  sigma_min   (s0) (t0)
  end
  |  orelim ?s0 ?s1 ?s2  =>  match   hexp  with
  |  orelim ?t0 ?t1 ?t2  =>  sigma_min   (s0) (t0); sigma_min   (s1) (t1); sigma_min   (s2) (t2)
  end
  |  subst_tm ?sigma0 ?s  =>  match   hexp  with
  |  subst_tm ?tau0 ?t  =>  sigma_min   (s) (t); sigma_min   (sigma0) (tau0)
  end
  |  ren_tm ?sigma0 ?s  =>  match   hexp  with
  |  ren_tm ?tau0 ?t  =>  sigma_min   (s) (t); sigma_min   (sigma0) (tau0)
  end
  |  (funcomp) (subst_tm ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_tm ?tau0) ?tau  =>  sigma_min   (sigma) (tau); sigma_min   (sigma0) (tau0)
  end
  |  (funcomp) (ren_tm ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (ren_tm ?tau0) ?tau  =>  sigma_min   (sigma) (tau); sigma_min   (sigma0) (tau0)
  end
  |  ?s  =>  unify   (gexp) (hexp)
  |  app (subst_tm ?sigma0 ?s0) (subst_tm ?sigma0 ?s1)  =>  first [ unify   (subst_tm sigma0 (app s0 s1)) (hexp)|  sigma_min   (subst_tm sigma0 (app s0 s1)) (hexp) ]
  |  lam ((fun x => x) ?s0) (subst_tm ((scons) (var_tm (var_zero)) ((funcomp) (ren_tm (shift)) ?sigma0)) ?s1)  =>  first [ unify   (subst_tm sigma0 (lam s0 s1)) (hexp)|  sigma_min   (subst_tm sigma0 (lam s0 s1)) (hexp) ]
  |  inl (subst_tm ?sigma0 ?s0)  =>  first [ unify   (subst_tm sigma0 (inl s0)) (hexp)|  sigma_min   (subst_tm sigma0 (inl s0)) (hexp) ]
  |  inr (subst_tm ?sigma0 ?s0)  =>  first [ unify   (subst_tm sigma0 (inr s0)) (hexp)|  sigma_min   (subst_tm sigma0 (inr s0)) (hexp) ]
  |  orelim (subst_tm ?sigma0 ?s0) (subst_tm ((scons) (var_tm (var_zero)) ((funcomp) (ren_tm (shift)) ?sigma0)) ?s1) (subst_tm ((scons) (var_tm (var_zero)) ((funcomp) (ren_tm (shift)) ?sigma0)) ?s2)  =>  first [ unify   (subst_tm sigma0 (orelim s0 s1 s2)) (hexp)|  sigma_min   (subst_tm sigma0 (orelim s0 s1 s2)) (hexp) ]
  |  app (ren_tm ?sigma0 ?s0) (ren_tm ?sigma0 ?s1)  =>  first [ unify   (ren_tm sigma0 (app s0 s1)) (hexp)|  sigma_min   (ren_tm sigma0 (app s0 s1)) (hexp) ]
  |  lam ((fun x => x) ?s0) (ren_tm ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s1)  =>  first [ unify   (ren_tm sigma0 (lam s0 s1)) (hexp)|  sigma_min   (ren_tm sigma0 (lam s0 s1)) (hexp) ]
  |  inl (ren_tm ?sigma0 ?s0)  =>  first [ unify   (ren_tm sigma0 (inl s0)) (hexp)|  sigma_min   (ren_tm sigma0 (inl s0)) (hexp) ]
  |  inr (ren_tm ?sigma0 ?s0)  =>  first [ unify   (ren_tm sigma0 (inr s0)) (hexp)|  sigma_min   (ren_tm sigma0 (inr s0)) (hexp) ]
  |  orelim (ren_tm ?sigma0 ?s0) (ren_tm ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s1) (ren_tm ((scons) (var_zero) ((funcomp) (shift) ?sigma0)) ?s2)  =>  first [ unify   (ren_tm sigma0 (orelim s0 s1 s2)) (hexp)|  sigma_min   (ren_tm sigma0 (orelim s0 s1 s2)) (hexp) ]
  |  ren_tm ((funcomp) ?tau0 ?sigma0) ?s  =>  match   hexp  with
  |  ren_tm ?theta0 ?t  =>  first [ unify   (ren_tm tau0 (ren_tm sigma0 s)) (hexp)|  sigma_min   (ren_tm tau0 (ren_tm sigma0 s)) (hexp) ]
  end
  |  subst_tm ((funcomp) ?tau0 ?sigma0) ?s  =>  match   hexp  with
  |  subst_tm ?theta0 ?t  =>  first [ unify   (subst_tm tau0 (ren_tm sigma0 s)) (hexp)|  sigma_min   (subst_tm tau0 (ren_tm sigma0 s)) (hexp) ]
  end
  |  subst_tm ((funcomp) (ren_tm ?tau0) ?sigma0) ?s  =>  match   hexp  with
  |  ren_tm ?theta0 ?t  =>  first [ unify   (ren_tm tau0 (subst_tm sigma0 s)) (hexp)|  sigma_min   (ren_tm tau0 (subst_tm sigma0 s)) (hexp) ]
  end
  |  subst_tm ((funcomp) (subst_tm ?tau0) ?sigma0) ?s  =>  match   hexp  with
  |  subst_tm ?theta0 ?t  =>  first [ unify   (subst_tm tau0 (subst_tm sigma0 s)) (hexp)|  sigma_min   (subst_tm tau0 (subst_tm sigma0 s)) (hexp) ]
  end
  |  (funcomp) (ren_tm ((funcomp) ?tau0 ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_tm ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (ren_tm tau0) ((funcomp) (ren_tm sigma0) sigmas)) (hexp)|  sigma_min   ((funcomp) (ren_tm tau0) ((funcomp) (ren_tm sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_tm ((funcomp) ?tau0 ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_tm ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (subst_tm tau0) ((funcomp) (ren_tm sigma0) sigmas)) (hexp)|  sigma_min   ((funcomp) (subst_tm tau0) ((funcomp) (ren_tm sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_tm ((funcomp) (ren_tm ?tau0) ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (ren_tm ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (ren_tm tau0) ((funcomp) (subst_tm sigma0) sigmas)) (hexp)|  sigma_min   ((funcomp) (ren_tm tau0) ((funcomp) (subst_tm sigma0) sigmas)) (hexp) ]
  end
  |  (funcomp) (subst_tm ((funcomp) (subst_tm ?tau0) ?sigma0)) ?sigmas  =>  match   hexp  with
  |  (funcomp) (subst_tm ?theta0) ?sigmat  =>  first [ unify   ((funcomp) (subst_tm tau0) ((funcomp) (subst_tm sigma0) sigmas)) (hexp)|  sigma_min   ((funcomp) (subst_tm tau0) ((funcomp) (subst_tm sigma0) sigmas)) (hexp) ]
  end
  |  (scons) (ren_tm ?sigma0 ?s) ((funcomp) (ren_tm ?sigma0) ?thetag)  =>  match   hexp  with
  |  (funcomp) (ren_tm ?tau0) ?thetah  =>  first [ unify   ((funcomp) (ren_tm sigma0) ((scons) s thetag)) (hexp)|  sigma_min   ((funcomp) (ren_tm sigma0) ((scons) s thetag)) (hexp) ]
  end
  |  (scons) (subst_tm ?sigma0 ?s) ((funcomp) (subst_tm ?sigma0) ?thetag)  =>  match   hexp  with
  |  (funcomp) (subst_tm ?tau0) ?thetah  =>  first [ unify   ((funcomp) (subst_tm sigma0) ((scons) s thetag)) (hexp)|  sigma_min   ((funcomp) (subst_tm sigma0) ((scons) s thetag)) (hexp) ]
  end
  end.
...
Ltac  heuristics gexp hexp :=
  ...
  assert ((funcomp) (subst_tm ((funcomp) var_tm sigma0)) sigma = (funcomp) (ren_tm sigma0) sigma) as eq by (renamify; reflexivity); rewrite   (eq); clear eq; heuristics   ((funcomp) (ren_tm sigma0) sigma) (hexp)
  end
  |  subst_tm ((funcomp) var_tm ?sigma0) ?s  =>  match   hexp  with
  |  ren_tm ?tau0 ?t  =>  let eq := fresh "eq" in
  assert (subst_tm ((funcomp) var_tm sigma0) s = ren_tm sigma0 s) as eq by (renamify; reflexivity); rewrite   (eq); clear eq; heuristics   (ren_tm sigma0 s) (hexp)
  end
  |  (funcomp) (ren_tm ?sigma0) ?sigma  =>  match   hexp  with
  |  (funcomp) (subst_tm ?tau0) ?tau  =>  let eq := fresh "eq" in
  assert ((funcomp) (ren_tm sigma0) sigma = (funcomp) (subst_tm ((funcomp) var_tm sigma0)) sigma) as eq by (substify; reflexivity); rewrite   (eq); clear eq; heuristics   ((funcomp) (subst_tm ((funcomp) var_tm sigma0)) sigma) (hexp)
  end
  |  ren_tm ?sigma0 ?s  =>  match   hexp  with
  |  subst_tm ?tau0 ?t  =>  let eq := fresh "eq" in
  assert (ren_tm sigma0 s = subst_tm ((funcomp) var_tm sigma0) s) as eq by (substify; reflexivity); rewrite   (eq); clear eq; heuristics   (subst_tm ((funcomp) var_tm sigma0) s) (hexp)
  end
  ...
  |  inl ?s0  =>  match   hexp  with
  |  inl ?t0  =>  heuristics   (s0) (t0)
  end
  |  inr ?s0  =>  match   hexp  with
  |  inr ?t0  =>  heuristics   (s0) (t0)
  end
  |  orelim ?s0 ?s1 ?s2  =>  match   hexp  with
  |  orelim ?t0 ?t1 ?t2  =>  heuristics   (s0) (t0); heuristics   (s1) (t1); heuristics   (s2) (t2)
  end
  |  subst_tm ?sigma0 ?s  =>  match   hexp  with
