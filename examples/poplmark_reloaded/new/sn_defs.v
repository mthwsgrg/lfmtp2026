From poplmark_reloaded.new Require Import stlc reduction.
...
| SBeta n A (M : tm (S n)) N : SN N -> SNRed (app (lam A M) N) M[N..]  
...
| SCaseL n (s: tm n) (u: tm (S n)) t : SN s -> SN t -> SN u -> SNRed (orelim (inl s) t u) t[s..]
| SCaseR n (s: tm n) (t: tm (S n)) u : SN s -> SN t -> SN u ->  SNRed (orelim (inr s) t u) u[s..].
