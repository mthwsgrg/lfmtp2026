...
From poplmark_reloaded.new Require Import stlc reduction sn_defs.
...
(* Weak Head Reduction *)
(** Old solution use indirect definitions for constructors redsn_caseL and redsn_caseR *)
...
| redsn_caseL n (s: tm n) t  (u: tm (S n)) : sn s -> sn t -> sn u  -> redsn (orelim (inl s) t u) t[s..]
| redsn_caseR n (s: tm n) (t: tm (S n)) u : sn s -> sn t -> sn u  ->  redsn (orelim (inr s) t u) u[s..]. 
